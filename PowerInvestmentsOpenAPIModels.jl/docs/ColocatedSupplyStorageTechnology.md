...
**`lifetime_solar`** | **`Int64`** | Units: yr. | [optional] [default to nothing]
...
**`lifetime_wind`** | **`Int64`** | Units: yr. | [optional] [default to nothing]
...
**`losses_storage`** | **`Float64`** | Units: 1. | [optional] [default to 1.0]
**`lifetime_storage`** | **`Int64`** | Units: yr. | [optional] [default to 100]
**`max_inverter_capacity`** | **`Float64`** | Units: MW. | [optional] [default to nothing]
**`min_inverter_capacity`** | **`Float64`** | Units: MW. | [optional] [default to nothing]
...
**`inverter_efficiency`** | **`Float64`** | Units: 1. | [optional] [default to nothing]
