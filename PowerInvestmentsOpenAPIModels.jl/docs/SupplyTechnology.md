...
**`capacity_limits`** | [**`*SupplyTechnologyCapacityLimits`**](SupplyTechnologyCapacityLimits.md) |  | [optional] [default to nothing]
**`outage_factor`** | [**`*OutageFactors`**](OutageFactors.md) |  | [optional] [default to nothing]
