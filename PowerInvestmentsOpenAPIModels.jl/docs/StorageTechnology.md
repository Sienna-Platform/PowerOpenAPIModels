...
**`min_discharge_fraction`** | **`Float64`** | Units: 1. | [optional] [default to 0.0]
...
**`unit_size_discharge`** | **`Float64`** | Units: MW. | [optional] [default to 0.0]
**`unit_size_charge`** | **`Float64`** | Units: MW. | [optional] [default to 0.0]
**`unit_size_energy`** | **`Float64`** | Units: MWh. | [optional] [default to 0.0]
...
**`losses`** | **`Float64`** | Units: 1. | [optional] [default to 1.0]
