...
**`capital_costs`** | [**`*StorageCapitalCost`**](StorageCapitalCost.md) |  | [optional] [default to nothing]
...
**`capacity_limits_charge`** | [**`*StorageTechnologyCapacityLimitsCharge`**](StorageTechnologyCapacityLimitsCharge.md) |  | [optional] [default to nothing]
**`capacity_limits_discharge`** | [**`*StorageTechnologyCapacityLimitsDischarge`**](StorageTechnologyCapacityLimitsDischarge.md) |  | [optional] [default to nothing]
**`capacity_limits_energy`** | [**`*StorageTechnologyCapacityLimitsEnergy`**](StorageTechnologyCapacityLimitsEnergy.md) |  | [optional] [default to nothing]
