...
function OpenAPI.check_required(o::FlexibleDemandTechnology)
...
function OpenAPI.validate_properties(o::FlexibleDemandTechnology)
    OpenAPI.validate_property(FlexibleDemandTechnology, Symbol("name"), o.name)
    OpenAPI.validate_property(FlexibleDemandTechnology, Symbol("id"), o.id)
    OpenAPI.validate_property(FlexibleDemandTechnology, Symbol("available"), o.available)
