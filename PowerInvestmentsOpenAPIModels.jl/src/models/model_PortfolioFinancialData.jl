...
@doc raw"""PortfolioFinancialData
    ...
    - name::String
    - discount_rate::Float64 : Units: 1.
    - inflation_rate::Float64 : Units: 1.
    - interest_rate::Float64 : Units: 1.
    - base_year::Int64
    - id::Int64
"""
...
function OpenAPI.validate_properties(o::PortfolioFinancialData)
    ...
    OpenAPI.validate_property(PortfolioFinancialData, Symbol("discount_rate"), o.discount_rate)
    OpenAPI.validate_property(PortfolioFinancialData, Symbol("inflation_rate"), o.inflation_rate)
    OpenAPI.validate_property(PortfolioFinancialData, Symbol("interest_rate"), o.interest_rate)
