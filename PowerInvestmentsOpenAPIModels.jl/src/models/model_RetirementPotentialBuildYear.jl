"""
    RetirementPotentialBuildYear

Optional dictionary to indicate the year in which existing generators in the base system were built.
"""
Base.@kwdef struct RetirementPotentialBuildYear <: APIModel
    additional_properties::Dict{String, Int64} = Dict{String, Int64}()
end
_decode(::Type{RetirementPotentialBuildYear}, value) =
    _decode(RetirementPotentialBuildYear, value, true)
function _decode(
    ::Type{RetirementPotentialBuildYear},
    _openapi_raw,
    ...
    return RetirementPotentialBuildYear(;
        additional_properties=_openapi_additional_properties,
    )
end
function _encode_unvalidated(_openapi_value::RetirementPotentialBuildYear)
