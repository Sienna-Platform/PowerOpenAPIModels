...
function OpenAPI.check_required(o::ACTransportTechnology)
    o.name === nothing && (return false)
    o.available === nothing && (return false)
    true
end

function OpenAPI.validate_properties(o::ACTransportTechnology)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("name"), o.name)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("base_year"), o.base_year)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("id"), o.id)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("available"), o.available)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("base_power"), o.base_power)
    OpenAPI.validate_property(
        ACTransportTechnology,
        Symbol("power_systems_type"),
        o.power_systems_type,
    )
    OpenAPI.validate_property(ACTransportTechnology, Symbol("start_region"), o.start_region)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("end_region"), o.end_region)
    OpenAPI.validate_property(
        ACTransportTechnology,
        Symbol("existing_line_capacity"),
        o.existing_line_capacity,
    )
    OpenAPI.validate_property(
        ACTransportTechnology,
        Symbol("maximum_new_capacity"),
        o.maximum_new_capacity,
    )
    OpenAPI.validate_property(ACTransportTechnology, Symbol("capital_cost"), o.capital_cost)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("line_loss"), o.line_loss)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("resistance"), o.resistance)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("voltage"), o.voltage)
    OpenAPI.validate_property(ACTransportTechnology, Symbol("angle_limit"), o.angle_limit)
    OpenAPI.validate_property(
        ACTransportTechnology,
