"""
    SupplyTechnologyCofireLevelLimits

Minimum and maximum blending level of each fuel during normal generation process for multi-fuel generator. Units: 1.
"""
Base.@kwdef struct SupplyTechnologyCofireLevelLimits <: APIModel
    additional_properties::Dict{String, MinMax} = Dict{String, MinMax}()
end
_decode(::Type{SupplyTechnologyCofireLevelLimits}, value) =
    _decode(SupplyTechnologyCofireLevelLimits, value, true)
function _decode(
    ::Type{SupplyTechnologyCofireLevelLimits},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/SupplyTechnology/properties/cofire_level_limits",
        ),
        _openapi_raw,
        "decoding SupplyTechnologyCofireLevelLimits";
        direction=:neutral,
    )
    ...
    return SupplyTechnologyCofireLevelLimits(;
...
function _encode(_openapi_value::SupplyTechnologyCofireLevelLimits)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding SupplyTechnologyCofireLevelLimits";
        direction=:neutral,
    )
end
