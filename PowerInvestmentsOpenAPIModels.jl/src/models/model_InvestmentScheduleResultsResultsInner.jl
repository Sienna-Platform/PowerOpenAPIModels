...
const _property_types_InvestmentScheduleResultsResultsInner = Dict{Symbol,String}(Symbol("technology")=>"String", Symbol("parameter")=>"String", Symbol("name")=>"String", Symbol("installations")=>"Vector{Float64}", )
