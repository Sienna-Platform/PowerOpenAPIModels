...
"""
Base.@kwdef struct HourlyMatching <: APIModel
    id::Int64
    name::String
    available::Bool
...
function _decode(::Type{HourlyMatching}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding HourlyMatching";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "HourlyMatching")
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "HourlyMatching"), false)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "HourlyMatching"), false)
    _openapi_field_available =
        _decode(Bool, _required(_openapi_object, "available", "HourlyMatching"), false)
    _openapi_additional_properties = Dict{String, Any}()
    for (_openapi_key, _openapi_item) in _openapi_object
        String(_openapi_key) in ("id", "name", "available") && continue
...
function _encode_unvalidated(_openapi_value::HourlyMatching)
...
_encode(_openapi_value::HourlyMatching) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-f43b07d269cc26eb3495.json",
        pointer="",
