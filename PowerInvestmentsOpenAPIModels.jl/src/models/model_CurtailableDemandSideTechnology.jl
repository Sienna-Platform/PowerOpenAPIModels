...
function OpenAPI.check_required(o::CurtailableDemandSideTechnology)
...
function OpenAPI.validate_properties(o::CurtailableDemandSideTechnology)
    OpenAPI.validate_property(CurtailableDemandSideTechnology, Symbol("name"), o.name)
    OpenAPI.validate_property(CurtailableDemandSideTechnology, Symbol("id"), o.id)
    ...
    OpenAPI.validate_property(CurtailableDemandSideTechnology, Symbol("voll"), o.voll)
    OpenAPI.validate_property(
        CurtailableDemandSideTechnology,
        Symbol("segments"),
        o.segments,
