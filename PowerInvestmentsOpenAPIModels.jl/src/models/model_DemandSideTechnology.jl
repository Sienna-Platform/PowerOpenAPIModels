...
function _decode(::Type{DemandSideTechnology}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-0767ecaabd38db61c5ee.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "DemandSideTechnology"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "DemandSideTechnology"),
        _openapi_validate,
    )
    ...
    _openapi_field_peak_demand_mw =
        ...
        _decode(
            Union{Absent, Float64, Nothing},
            _openapi_object["peak_demand_mw"],
            _openapi_validate,
        ) : ABSENT
...
function _encode(_openapi_value::DemandSideTechnology)
    ...
    _openapi_value.technology_efficiency isa Absent || (
        _openapi_output["technology_efficiency"] =
            _encode(_openapi_value.technology_efficiency)
    )
    ...
    _openapi_value.min_power isa Absent ||
        (_openapi_output["min_power"] = _encode(_openapi_value.min_power))
    _openapi_value.peak_demand_mw isa Absent ||
        (_openapi_output["peak_demand_mw"] = _encode(_openapi_value.peak_demand_mw))
    _openapi_value.max_demand_delay isa Absent ||
        (_openapi_output["max_demand_delay"] = _encode(_openapi_value.max_demand_delay))
    _openapi_value.max_demand_advance isa Absent ||
        (_openapi_output["max_demand_advance"] = _encode(_openapi_value.max_demand_advance))
    _openapi_value.demand_energy_efficiency isa Absent || (
        _openapi_output["demand_energy_efficiency"] =
            _encode(_openapi_value.demand_energy_efficiency)
    )
    ...
    _openapi_value.max_demand_curtailment isa Absent || (
        _openapi_output["max_demand_curtailment"] =
            _encode(_openapi_value.max_demand_curtailment)
    )
