"""
    StorageTechnologyOperationCosts
...
"""
Base.@kwdef struct StorageTechnologyOperationCosts <: APIModel
...
_decode(::Type{StorageTechnologyOperationCosts}, value) =
    _decode(StorageTechnologyOperationCosts, value, true)
function _decode(
    ::Type{StorageTechnologyOperationCosts},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/StorageTechnology/properties/operation_costs",
        ),
        _openapi_raw,
        "decoding StorageTechnologyOperationCosts";
        direction=:neutral,
    )
    ...
    _openapi_field_fixed = _decode(
        Float64,
        _required(_openapi_object, "fixed", "StorageTechnologyOperationCosts"),
        _openapi_validate,
    )
    _openapi_field_shut_down = _decode(
        Float64,
        _required(_openapi_object, "shut_down", "StorageTechnologyOperationCosts"),
        _openapi_validate,
    )
    _openapi_field_start_up = _decode(
        StorageTechnologyOperationCostsStartUp,
        _required(_openapi_object, "start_up", "StorageTechnologyOperationCosts"),
        _openapi_validate,
    )
    ...
    return StorageTechnologyOperationCosts(;
...
function _encode(_openapi_value::StorageTechnologyOperationCosts)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding StorageTechnologyOperationCosts";
        direction=:neutral,
    )
end
