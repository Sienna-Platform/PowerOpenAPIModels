...
function _decode(::Type{CarbonCaps}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "CarbonCaps"),
        _openapi_validate,
    )
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "CarbonCaps"), _openapi_validate)
    _openapi_field_max_mtons =
        haskey(_openapi_object, "max_mtons") ?
        _decode(
            Union{Absent, Float64, Nothing},
            _openapi_object["max_mtons"],
            _openapi_validate,
        ) : ABSENT
    _openapi_field_max_tons_mwh =
        ...
        _decode(
            Union{Absent, Float64, Nothing},
            _openapi_object["max_tons_mwh"],
            _openapi_validate,
        ) : ABSENT
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "CarbonCaps"), _openapi_validate)
    ...
    for (_openapi_key, _openapi_item) in _openapi_object
        ...
        ("available", "id", "max_mtons", "max_tons_mwh", "name", "target_year") && continue
...
function _encode(_openapi_value::CarbonCaps)
    ...
    _openapi_value.max_mtons isa Absent ||
        (_openapi_output["max_mtons"] = _encode(_openapi_value.max_mtons))
    _openapi_value.max_tons_mwh isa Absent ||
        (_openapi_output["max_tons_mwh"] = _encode(_openapi_value.max_tons_mwh))
