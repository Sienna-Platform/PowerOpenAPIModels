...
_decode(::Type{TechnologyFinancialData}, value) =
    _decode(TechnologyFinancialData, value, true)
function _decode(::Type{TechnologyFinancialData}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-a78285f8bbf36335c882.json",
            pointer="",
        ),
        _openapi_raw,
...
function _form_fields(_openapi_value::TechnologyFinancialData)
    ...
    _openapi_value.capital_recovery_period isa Absent || push!(
        _openapi_output,
    ...
    _openapi_value.debt_rate isa Absent ||
        push!(_openapi_output, "debt_rate" => _openapi_value.debt_rate)
    _openapi_value.return_on_equity isa Absent ||
