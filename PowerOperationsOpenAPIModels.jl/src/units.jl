...
InfrastructureCoreOpenAPIModels.has_declared_unit(::Type{HydroTurbine}, ::Val{:time_at_status}) = true
InfrastructureCoreOpenAPIModels.declared_unit(::Type{HydroTurbine}, ::Val{:time_at_status}) = "min"
InfrastructureCoreOpenAPIModels.declared_quantity(::Type{HydroTurbine}, ::Val{:time_at_status}) = "OperationalDuration"
...
InfrastructureCoreOpenAPIModels.has_declared_unit(::Type{SwitchedAdmittance}, ::Val{:solved_admittance}) = true
function InfrastructureCoreOpenAPIModels.declared_unit(o::SwitchedAdmittance, ::Val{:solved_admittance})
    if string(o.admittance_units) == "NATURAL_UNITS"
        return "S"
    end
    if string(o.admittance_units) == "COMPONENT_MVAR"
    ...
    error("SwitchedAdmittance.solved_admittance: no unit declared for admittance_units=$(o.admittance_units)")
end
function InfrastructureCoreOpenAPIModels.declared_quantity(o::SwitchedAdmittance, ::Val{:solved_admittance})
    if string(o.admittance_units) == "NATURAL_UNITS"
        return "Susceptance"
    end
    if string(o.admittance_units) == "COMPONENT_MVAR"
