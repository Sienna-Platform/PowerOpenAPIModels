...
function _decode(::Type{HydroTurbine}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroTurbine"), _openapi_raw, "decoding HydroTurbine"; direction = :neutral)
...
function _encode(_openapi_value::HydroTurbine)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroTurbine"), _openapi_output, "encoding HydroTurbine"; direction = :neutral)
end
