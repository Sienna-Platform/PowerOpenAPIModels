...
function _decode(::Type{RenewableDispatchPrimeMoverType}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/prime_mover_type"), value, "decoding RenewableDispatchPrimeMoverType"; direction = :neutral)
...
function _encode(value::RenewableDispatchPrimeMoverType)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/prime_mover_type"), output, "encoding RenewableDispatchPrimeMoverType"; direction = :neutral)
end
