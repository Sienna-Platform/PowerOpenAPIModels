...
function _decode(::Type{FACTSControlDevice}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice"), _openapi_raw, "decoding FACTSControlDevice"; direction = :neutral)
...
function _encode(_openapi_value::FACTSControlDevice)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice"), _openapi_output, "encoding FACTSControlDevice"; direction = :neutral)
end
