...
function _decode(::Type{FACTSControlDevice}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-8fc75f1962f679b768d1.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "FACTSControlDevice"),
        _openapi_validate,
    )
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "FACTSControlDevice"),
        _openapi_validate,
    )
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "FACTSControlDevice"),
        _openapi_validate,
    )
    _openapi_field_bus = _decode(
        Int64,
        _required(_openapi_object, "bus", "FACTSControlDevice"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::FACTSControlDevice)
    ...
    _openapi_value.max_shunt_current isa Absent ||
        (_openapi_output["max_shunt_current"] = _encode(_openapi_value.max_shunt_current))
    _openapi_value.reactive_power_required isa Absent || (
        _openapi_output["reactive_power_required"] =
            _encode(_openapi_value.reactive_power_required)
    )
