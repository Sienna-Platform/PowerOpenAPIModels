...
"""
Base.@kwdef struct PlantAssociation <: APIModel
    plant_id::Int64
    entity_id::Int64
    group_index::Int64
...
function _decode(::Type{PlantAssociation}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-3d1ad4535300228c5108.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding PlantAssociation";
        direction=:neutral,
    )
    ...
    return PlantAssociation(;
        ...
        group_index=_openapi_field_group_index,
...
function _form_fields(_openapi_value::PlantAssociation)
    ...
    _openapi_value.group_index isa Absent ||
        push!(_openapi_output, "group_index" => _openapi_value.group_index)
