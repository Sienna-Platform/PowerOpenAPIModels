...
function _decode(::Type{ExponentialLoadConformity}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ExponentialLoad/properties/conformity"), value, "decoding ExponentialLoadConformity"; direction = :neutral)
...
function _encode(value::ExponentialLoadConformity)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ExponentialLoad/properties/conformity"), output, "encoding ExponentialLoadConformity"; direction = :neutral)
end
