...
function _decode(::Type{ShiftablePowerLoad}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "ShiftablePowerLoad"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "ShiftablePowerLoad"),
        _openapi_validate,
    )
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "ShiftablePowerLoad"),
        _openapi_validate,
    )
    _openapi_field_bus = _decode(
        Int64,
        _required(_openapi_object, "bus", "ShiftablePowerLoad"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::ShiftablePowerLoad)
    ...
    _openapi_value.load_balance_time_horizon isa Absent || (
        _openapi_output["load_balance_time_horizon"] =
            _encode(_openapi_value.load_balance_time_horizon)
    )
