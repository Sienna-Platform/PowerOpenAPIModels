...
function _decode(::Type{InterconnectingConverterDcControl}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter/properties/dc_control"), value, "decoding InterconnectingConverterDcControl"; direction = :neutral)
...
function _encode(value::InterconnectingConverterDcControl)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter/properties/dc_control"), output, "encoding InterconnectingConverterDcControl"; direction = :neutral)
end
