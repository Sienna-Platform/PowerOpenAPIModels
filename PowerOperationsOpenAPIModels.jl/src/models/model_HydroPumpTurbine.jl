...
function _decode(::Type{HydroPumpTurbine}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine"), _openapi_raw, "decoding HydroPumpTurbine"; direction = :neutral)
...
function _encode(_openapi_value::HydroPumpTurbine)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine"), _openapi_output, "encoding HydroPumpTurbine"; direction = :neutral)
end
