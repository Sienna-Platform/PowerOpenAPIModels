"""
    TwoTerminalVSCLineConverterLossFrom
...
"""
Base.@kwdef struct TwoTerminalVSCLineConverterLossFrom <: APIModel
    curve_type::String
    function_data::TwoTerminalVSCLineConverterLossFromFunctionData
    input_at_zero::Union{Absent, Float64, Nothing} = ABSENT
    additional_properties::Dict{String, Any} = Dict{String, Any}()
end
_decode(::Type{TwoTerminalVSCLineConverterLossFrom}, value) =
    _decode(TwoTerminalVSCLineConverterLossFrom, value, true)
function _decode(
    ::Type{TwoTerminalVSCLineConverterLossFrom},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TwoTerminalVSCLine/properties/converter_loss_from",
        ),
        _openapi_raw,
        "decoding TwoTerminalVSCLineConverterLossFrom";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "TwoTerminalVSCLineConverterLossFrom")
    _openapi_field_curve_type = _decode(
        String,
        _required(_openapi_object, "curve_type", "TwoTerminalVSCLineConverterLossFrom"),
        _openapi_validate,
    )
    _openapi_field_function_data = _decode(
        TwoTerminalVSCLineConverterLossFromFunctionData,
        _required(_openapi_object, "function_data", "TwoTerminalVSCLineConverterLossFrom"),
        _openapi_validate,
    )
    ...
    return TwoTerminalVSCLineConverterLossFrom(;
...
function _encode(_openapi_value::TwoTerminalVSCLineConverterLossFrom)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TwoTerminalVSCLineConverterLossFrom";
        direction=:neutral,
    )
end
