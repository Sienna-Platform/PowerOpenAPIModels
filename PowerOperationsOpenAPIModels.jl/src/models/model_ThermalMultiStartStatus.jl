...
function _decode(::Type{ThermalMultiStartStatus}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/status"), value, "decoding ThermalMultiStartStatus"; direction = :neutral)
    return ThermalMultiStartStatus(_decode(String, value, _openapi_validate))
end
function _encode(value::ThermalMultiStartStatus)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/status"), output, "encoding ThermalMultiStartStatus"; direction = :neutral)
end
