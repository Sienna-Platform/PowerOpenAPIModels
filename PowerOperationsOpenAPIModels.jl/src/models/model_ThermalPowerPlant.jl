...
function _decode(::Type{ThermalPowerPlant}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalPowerPlant"), _openapi_raw, "decoding ThermalPowerPlant"; direction = :neutral)
...
function _encode(_openapi_value::ThermalPowerPlant)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalPowerPlant"), _openapi_output, "encoding ThermalPowerPlant"; direction = :neutral)
end
