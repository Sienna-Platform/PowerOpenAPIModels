...
"""
Base.@kwdef struct DiscreteControlledACBranch <: APIModel
    id::Int64
    name::String
    available::Bool
...
_decode(::Type{DiscreteControlledACBranch}, value) =
    _decode(DiscreteControlledACBranch, value, true)
function _decode(::Type{DiscreteControlledACBranch}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-3723e3b1b23ec1dc2bf5.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding DiscreteControlledACBranch";
        direction=:neutral,
    )
...
function _form_fields(_openapi_value::DiscreteControlledACBranch)
    ...
    _openapi_value.branch_status isa Absent ||
        push!(_openapi_output, "branch_status" => _openapi_value.branch_status)
    _openapi_value.normal_branch_status isa Absent || push!(
        _openapi_output,
        "normal_branch_status" => _openapi_value.normal_branch_status,
    )
