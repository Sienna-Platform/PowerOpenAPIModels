...
function _decode(::Type{CombinedCycleBlock}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-ba62e62e22457bfcb8dc.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "CombinedCycleBlock"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "CombinedCycleBlock"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::CombinedCycleBlock)
    ...
    _openapi_value.heat_recovery_to_steam_factor isa Absent || (
        _openapi_output["heat_recovery_to_steam_factor"] =
            _encode(_openapi_value.heat_recovery_to_steam_factor)
    )
