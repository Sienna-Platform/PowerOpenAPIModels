...
function _decode(::Type{HydroTurbinePowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroTurbine/properties/power_units"), value, "decoding HydroTurbinePowerUnits"; direction = :neutral)
    return HydroTurbinePowerUnits(_decode(String, value, _openapi_validate))
end
function _encode(value::HydroTurbinePowerUnits)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroTurbine/properties/power_units"), output, "encoding HydroTurbinePowerUnits"; direction = :neutral)
end
