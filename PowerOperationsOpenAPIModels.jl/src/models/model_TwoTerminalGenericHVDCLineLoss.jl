...
function _decode(::Type{TwoTerminalGenericHVDCLineLoss}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalGenericHVDCLine/properties/loss"), value, "decoding TwoTerminalGenericHVDCLineLoss"; direction = :neutral)
...
function _encode(value::TwoTerminalGenericHVDCLineLoss)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalGenericHVDCLine/properties/loss"), output, "encoding TwoTerminalGenericHVDCLineLoss"; direction = :neutral)
end
