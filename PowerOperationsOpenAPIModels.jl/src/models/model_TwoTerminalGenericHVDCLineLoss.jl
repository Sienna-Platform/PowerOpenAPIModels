...
"""
struct TwoTerminalGenericHVDCLineLoss <: OneOfAPIModel
    value::Union{IncrementalCurve, InputOutputCurve}
end
_decode(::Type{TwoTerminalGenericHVDCLineLoss}, value) =
    _decode(TwoTerminalGenericHVDCLineLoss, value, true)
function _decode(::Type{TwoTerminalGenericHVDCLineLoss}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TwoTerminalGenericHVDCLine/properties/loss",
        ),
        value,
        "decoding TwoTerminalGenericHVDCLineLoss";
        direction=:neutral,
    )
    ...
    tag isa Absent ||
        ...
        throw(
            DecodeError(
                "discriminator value must be a string for TwoTerminalGenericHVDCLineLoss",
            ),
        )
    selected = get(
        Dict(
    ...
    selected === nothing && throw(
        DecodeError(
            "unknown discriminator value $(repr(tag)) for TwoTerminalGenericHVDCLineLoss",
        ),
    )
    !_openapi_validate ||
        ...
        throw(
            DecodeError(
                "discriminator-selected schema did not validate for TwoTerminalGenericHVDCLineLoss",
            ),
        )
...
function _encode(value::TwoTerminalGenericHVDCLineLoss)
    ...
    return _validate_schema(
        ...
        output,
        "encoding TwoTerminalGenericHVDCLineLoss";
        direction=:neutral,
    )
end
