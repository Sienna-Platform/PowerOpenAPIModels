...
function _decode(::Type{TwoTerminalVSCLineDcControlTo}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/dc_control_to"), value, "decoding TwoTerminalVSCLineDcControlTo"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineDcControlTo)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/dc_control_to"), output, "encoding TwoTerminalVSCLineDcControlTo"; direction = :neutral)
end
