...
function _decode(::Type{ThermalMultiStartOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/operation_cost"), value, "decoding ThermalMultiStartOperationCost"; direction = :neutral)
...
function _encode(value::ThermalMultiStartOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/operation_cost"), output, "encoding ThermalMultiStartOperationCost"; direction = :neutral)
end
