...
function _decode(::Type{ShiftablePowerLoadOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ShiftablePowerLoad/properties/operation_cost"), value, "decoding ShiftablePowerLoadOperationCost"; direction = :neutral)
...
function _encode(value::ShiftablePowerLoadOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ShiftablePowerLoad/properties/operation_cost"), output, "encoding ShiftablePowerLoadOperationCost"; direction = :neutral)
end
