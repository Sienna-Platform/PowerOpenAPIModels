...
function _decode(::Type{ThermalStandardPrimeMoverType}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalStandard/properties/prime_mover_type"), value, "decoding ThermalStandardPrimeMoverType"; direction = :neutral)
...
function _encode(value::ThermalStandardPrimeMoverType)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalStandard/properties/prime_mover_type"), output, "encoding ThermalStandardPrimeMoverType"; direction = :neutral)
end
