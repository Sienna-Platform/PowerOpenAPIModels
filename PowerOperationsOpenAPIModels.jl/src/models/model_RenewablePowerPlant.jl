...
function _decode(::Type{RenewablePowerPlant}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-ef9c04faf9bbdabaf50c.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "RenewablePowerPlant"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "RenewablePowerPlant"),
        _openapi_validate,
    )
