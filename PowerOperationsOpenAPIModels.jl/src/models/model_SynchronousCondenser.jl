...
function _decode(::Type{SynchronousCondenser}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-f8ac3358856857de592b.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "SynchronousCondenser"), false)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "SynchronousCondenser"), false)
    ...
    _openapi_field_bus =
        _decode(Int64, _required(_openapi_object, "bus", "SynchronousCondenser"), false)
...
function _encode_unvalidated(_openapi_value::SynchronousCondenser)
    ...
    _openapi_value.active_power_losses isa Absent || (
        _openapi_output["active_power_losses"] =
            _encode_unvalidated(_openapi_value.active_power_losses)
    )
...
_encode(_openapi_value::SynchronousCondenser) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-f8ac3358856857de592b.json",
        pointer="",
