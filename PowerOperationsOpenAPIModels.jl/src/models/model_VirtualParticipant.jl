...
function _decode(::Type{VirtualParticipant}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/VirtualParticipant"), _openapi_raw, "decoding VirtualParticipant"; direction = :neutral)
...
function _encode(_openapi_value::VirtualParticipant)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/VirtualParticipant"), _openapi_output, "encoding VirtualParticipant"; direction = :neutral)
end
