...
_decode(::Type{TwoTerminalGenericHVDCLine}, value) =
    _decode(TwoTerminalGenericHVDCLine, value, true)
function _decode(::Type{TwoTerminalGenericHVDCLine}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-eed3b20a4e1cf2304d83.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_reactive_power_limits_to = _decode(
        MinMax,
        _required(
            _openapi_object,
