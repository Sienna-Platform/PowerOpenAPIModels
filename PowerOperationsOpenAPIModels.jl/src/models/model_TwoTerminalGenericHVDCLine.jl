...
function _decode(::Type{TwoTerminalGenericHVDCLine}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalGenericHVDCLine"), _openapi_raw, "decoding TwoTerminalGenericHVDCLine"; direction = :neutral)
...
function _encode(_openapi_value::TwoTerminalGenericHVDCLine)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalGenericHVDCLine"), _openapi_output, "encoding TwoTerminalGenericHVDCLine"; direction = :neutral)
end
