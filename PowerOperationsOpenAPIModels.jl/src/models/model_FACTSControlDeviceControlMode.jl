...
function _decode(::Type{FACTSControlDeviceControlMode}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice/properties/control_mode"), value, "decoding FACTSControlDeviceControlMode"; direction = :neutral)
...
function _encode(value::FACTSControlDeviceControlMode)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice/properties/control_mode"), output, "encoding FACTSControlDeviceControlMode"; direction = :neutral)
end
