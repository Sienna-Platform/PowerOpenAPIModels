...
"""
Base.@kwdef struct InterconnectingConverterLossFunction <: APIModel
    curve_type::String
...
_decode(::Type{InterconnectingConverterLossFunction}, value) =
    _decode(InterconnectingConverterLossFunction, value, true)
function _decode(
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/InterconnectingConverter/properties/loss_function",
        ),
        _openapi_raw,
        "decoding InterconnectingConverterLossFunction";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "InterconnectingConverterLossFunction")
    _openapi_field_curve_type = _decode(
        String,
        _required(_openapi_object, "curve_type", "InterconnectingConverterLossFunction"),
        _openapi_validate,
    )
    _openapi_field_function_data = _decode(
        InterconnectingConverterLossFunctionFunctionData,
        _required(_openapi_object, "function_data", "InterconnectingConverterLossFunction"),
        _openapi_validate,
    )
    ...
    return InterconnectingConverterLossFunction(;
...
function _encode(_openapi_value::InterconnectingConverterLossFunction)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding InterconnectingConverterLossFunction";
        direction=:neutral,
    )
end
