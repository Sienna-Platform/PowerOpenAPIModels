...
function _decode(::Type{HydroReservoirOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroReservoir/properties/operation_cost"), value, "decoding HydroReservoirOperationCost"; direction = :neutral)
    ...
    selected = get(Dict(
        "HYDRO_RES" => (HydroReservoirCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroReservoirCost")),
        "HydroReservoirCost" => (HydroReservoirCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroReservoirCost")),
...
function _encode(value::HydroReservoirOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroReservoir/properties/operation_cost"), output, "encoding HydroReservoirOperationCost"; direction = :neutral)
end
