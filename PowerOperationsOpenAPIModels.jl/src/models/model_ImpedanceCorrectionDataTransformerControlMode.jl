...
function _decode(::Type{ImpedanceCorrectionDataTransformerControlMode}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ImpedanceCorrectionData/properties/transformer_control_mode"), value, "decoding ImpedanceCorrectionDataTransformerControlMode"; direction = :neutral)
...
function _encode(value::ImpedanceCorrectionDataTransformerControlMode)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ImpedanceCorrectionData/properties/transformer_control_mode"), output, "encoding ImpedanceCorrectionDataTransformerControlMode"; direction = :neutral)
end
