...
function _decode(::Type{TModelHVDCLineActivePowerLimitsTo}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TModelHVDCLine/properties/active_power_limits_to"), _openapi_raw, "decoding TModelHVDCLineActivePowerLimitsTo"; direction = :neutral)
...
function _encode(_openapi_value::TModelHVDCLineActivePowerLimitsTo)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TModelHVDCLine/properties/active_power_limits_to"), _openapi_output, "encoding TModelHVDCLineActivePowerLimitsTo"; direction = :neutral)
end
