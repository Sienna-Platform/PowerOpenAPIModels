...
function _decode(::Type{InterconnectingConverterAcControl}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter/properties/ac_control"), value, "decoding InterconnectingConverterAcControl"; direction = :neutral)
...
function _encode(value::InterconnectingConverterAcControl)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter/properties/ac_control"), output, "encoding InterconnectingConverterAcControl"; direction = :neutral)
end
