...
"""
Base.@kwdef struct TransmissionInterfaceDirectionMapping <: APIModel
    additional_properties::Dict{String, Int64} = Dict{String, Int64}()
end
_decode(::Type{TransmissionInterfaceDirectionMapping}, value) =
    _decode(TransmissionInterfaceDirectionMapping, value, true)
function _decode(
    ::Type{TransmissionInterfaceDirectionMapping},
    _openapi_raw,
    ...
    return TransmissionInterfaceDirectionMapping(;
        additional_properties=_openapi_additional_properties,
    )
end
function _encode_unvalidated(_openapi_value::TransmissionInterfaceDirectionMapping)
...
_encode(_openapi_value::TransmissionInterfaceDirectionMapping) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-b9275b9f7d62731a8b45.json",
        pointer="/properties/direction_mapping",
