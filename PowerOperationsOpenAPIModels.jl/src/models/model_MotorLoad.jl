...
function _decode(::Type{MotorLoad}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/MotorLoad"), _openapi_raw, "decoding MotorLoad"; direction = :neutral)
...
function _encode(_openapi_value::MotorLoad)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/MotorLoad"), _openapi_output, "encoding MotorLoad"; direction = :neutral)
end
