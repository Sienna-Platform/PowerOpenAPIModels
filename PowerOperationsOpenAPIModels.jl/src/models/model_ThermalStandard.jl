...
function _decode(::Type{ThermalStandard}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-6785e6f315553a88c35d.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "ThermalStandard"),
        _openapi_validate,
    )
    ...
    _openapi_field_rating = _decode(
        Float64,
        _required(_openapi_object, "rating", "ThermalStandard"),
        _openapi_validate,
    )
    ...
    _openapi_field_base_power = _decode(
        Float64,
        _required(_openapi_object, "base_power", "ThermalStandard"),
        _openapi_validate,
    )
    ...
    _openapi_field_fuel =
        ...
        _decode(
            Union{Absent, Nothing, ThermalFuels},
