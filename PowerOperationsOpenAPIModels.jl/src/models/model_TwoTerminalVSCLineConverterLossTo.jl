...
"""
Base.@kwdef struct TwoTerminalVSCLineConverterLossTo <: APIModel
    curve_type::String
    function_data::TwoTerminalVSCLineConverterLossToFunctionData
    input_at_zero::Union{Absent, Float64, Nothing} = ABSENT
    additional_properties::Dict{String, Any} = Dict{String, Any}()
end
_decode(::Type{TwoTerminalVSCLineConverterLossTo}, value) =
    _decode(TwoTerminalVSCLineConverterLossTo, value, true)
function _decode(
    ::Type{TwoTerminalVSCLineConverterLossTo},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TwoTerminalVSCLine/properties/converter_loss_to",
        ),
        _openapi_raw,
        "decoding TwoTerminalVSCLineConverterLossTo";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "TwoTerminalVSCLineConverterLossTo")
    _openapi_field_curve_type = _decode(
        String,
        _required(_openapi_object, "curve_type", "TwoTerminalVSCLineConverterLossTo"),
        _openapi_validate,
    )
    _openapi_field_function_data = _decode(
        TwoTerminalVSCLineConverterLossToFunctionData,
        _required(_openapi_object, "function_data", "TwoTerminalVSCLineConverterLossTo"),
        _openapi_validate,
    )
    ...
    return TwoTerminalVSCLineConverterLossTo(;
...
function _encode(_openapi_value::TwoTerminalVSCLineConverterLossTo)
    ...
    _openapi_value.input_at_zero isa Absent ||
        (_openapi_output["input_at_zero"] = _encode(_openapi_value.input_at_zero))
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TwoTerminalVSCLineConverterLossTo";
        direction=:neutral,
    )
end
