...
"""
Base.@kwdef struct HybridSystemOperationCost <: APIModel
...
_decode(::Type{HybridSystemOperationCost}, value) =
    _decode(HybridSystemOperationCost, value, true)
function _decode(::Type{HybridSystemOperationCost}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/HybridSystem/properties/operation_cost",
        ),
        _openapi_raw,
        "decoding HybridSystemOperationCost";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "HybridSystemOperationCost")
    _openapi_field_ancillary_service_offers = _decode(
        Vector{Int64},
        _required(_openapi_object, "ancillary_service_offers", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    ...
    _openapi_field_curve_style =
        ...
        _decode(
            Union{Absent, HybridSystemOperationCostCurveStyle, Nothing},
            _openapi_object["curve_style"],
            _openapi_validate,
        ) : ABSENT
    _openapi_field_decremental_offer_curves = _decode(
        CostCurve,
        _required(_openapi_object, "decremental_offer_curves", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    ...
    _openapi_field_incremental_offer_curves = _decode(
        CostCurve,
        _required(_openapi_object, "incremental_offer_curves", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    ...
    _openapi_field_minimum_energy_offer = _decode(
        InputOutputCurve,
        _required(_openapi_object, "minimum_energy_offer", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    _openapi_field_shut_down = _decode(
        InputOutputCurve,
        _required(_openapi_object, "shut_down", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    _openapi_field_start_up = _decode(
        StartUpStages,
        _required(_openapi_object, "start_up", "HybridSystemOperationCost"),
        _openapi_validate,
    )
    ...
    return HybridSystemOperationCost(;
...
function _encode(_openapi_value::HybridSystemOperationCost)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding HybridSystemOperationCost";
        direction=:neutral,
    )
end
