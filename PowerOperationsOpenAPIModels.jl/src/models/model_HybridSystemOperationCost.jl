...
function _decode(::Type{HybridSystemOperationCost}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HybridSystem/properties/operation_cost"), _openapi_raw, "decoding HybridSystemOperationCost"; direction = :neutral)
...
function _encode(_openapi_value::HybridSystemOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HybridSystem/properties/operation_cost"), _openapi_output, "encoding HybridSystemOperationCost"; direction = :neutral)
end
