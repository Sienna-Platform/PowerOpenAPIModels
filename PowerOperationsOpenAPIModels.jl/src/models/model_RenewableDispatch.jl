...
function _decode(::Type{RenewableDispatch}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch"), _openapi_raw, "decoding RenewableDispatch"; direction = :neutral)
...
function _encode(_openapi_value::RenewableDispatch)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch"), _openapi_output, "encoding RenewableDispatch"; direction = :neutral)
end
