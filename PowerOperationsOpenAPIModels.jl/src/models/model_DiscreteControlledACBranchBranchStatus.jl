...
function _decode(::Type{DiscreteControlledACBranchBranchStatus}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DiscreteControlledACBranch/properties/branch_status"), value, "decoding DiscreteControlledACBranchBranchStatus"; direction = :neutral)
...
function _encode(value::DiscreteControlledACBranchBranchStatus)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DiscreteControlledACBranch/properties/branch_status"), output, "encoding DiscreteControlledACBranchBranchStatus"; direction = :neutral)
end
