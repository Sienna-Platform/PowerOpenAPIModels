...
function _decode(::Type{StandardLoadConformity}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/StandardLoad/properties/conformity"), value, "decoding StandardLoadConformity"; direction = :neutral)
    return StandardLoadConformity(_decode(String, value, _openapi_validate))
end
function _encode(value::StandardLoadConformity)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/StandardLoad/properties/conformity"), output, "encoding StandardLoadConformity"; direction = :neutral)
end
