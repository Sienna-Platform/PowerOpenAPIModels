...
function _decode(::Type{RenewableDispatchOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/operation_cost"), value, "decoding RenewableDispatchOperationCost"; direction = :neutral)
    ...
    selected = get(Dict(
        ...
        "RENEWABLE" => (RenewableGenerationCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableGenerationCost")),
        "RenewableGenerationCost" => (RenewableGenerationCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableGenerationCost")),
...
function _encode(value::RenewableDispatchOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/operation_cost"), output, "encoding RenewableDispatchOperationCost"; direction = :neutral)
end
