...
function _decode(::Type{TwoWindingTransformerShuntLocation2}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoWindingTransformer/properties/shunt_location"), value, "decoding TwoWindingTransformerShuntLocation2"; direction = :neutral)
...
function _encode(value::TwoWindingTransformerShuntLocation2)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoWindingTransformer/properties/shunt_location"), output, "encoding TwoWindingTransformerShuntLocation2"; direction = :neutral)
end
