...
function _decode(::Type{ThermalMultiStart}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/ThermalMultiStart",
        ),
        _openapi_raw,
    ...
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "ThermalMultiStart"),
        _openapi_validate,
    )
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "ThermalMultiStart"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "ThermalMultiStart"),
        _openapi_validate,
    )
    ...
    _openapi_field_rating = _decode(
        Float64,
        _required(_openapi_object, "rating", "ThermalMultiStart"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::ThermalMultiStart)
    ...
    _openapi_value.power_trajectory isa Absent ||
        (_openapi_output["power_trajectory"] = _encode(_openapi_value.power_trajectory))
    ...
    _openapi_value.start_time_limits isa Absent ||
        (_openapi_output["start_time_limits"] = _encode(_openapi_value.start_time_limits))
    _openapi_value.start_types isa Absent ||
        (_openapi_output["start_types"] = _encode(_openapi_value.start_types))
