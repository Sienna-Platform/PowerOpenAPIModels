...
"""
Base.@kwdef struct ThermalMultiStart <: APIModel
    id::Int64
    name::String
    available::Bool
    ...
    power_trajectory::Union{Absent, Nothing, StartUpShutDown} = ABSENT
    time_limits::Union{Absent, Nothing, UpDown} = ABSENT
    start_time_limits::Union{Absent, Nothing, StartUpStages} = ABSENT
    start_types::Int64
...
function _decode(::Type{ThermalMultiStart}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding ThermalMultiStart";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "ThermalMultiStart")
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "ThermalMultiStart"), false)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "ThermalMultiStart"), false)
    _openapi_field_available =
        _decode(Bool, _required(_openapi_object, "available", "ThermalMultiStart"), false)
    _openapi_field_status = _decode(
        OperationalStates,
        _required(_openapi_object, "status", "ThermalMultiStart"),
        false,
    )
    ...
    _openapi_field_bus =
        _decode(Int64, _required(_openapi_object, "bus", "ThermalMultiStart"), false)
    ...
    _openapi_field_reactive_power = _decode(
        Float64,
        _required(_openapi_object, "reactive_power", "ThermalMultiStart"),
        false,
    )
    _openapi_field_rating =
        _decode(Float64, _required(_openapi_object, "rating", "ThermalMultiStart"), false)
    _openapi_field_prime_mover_type = _decode(
        PrimeMovers,
        _required(_openapi_object, "prime_mover_type", "ThermalMultiStart"),
        false,
    )
    _openapi_field_fuel = _decode(
        ThermalFuels,
        _required(_openapi_object, "fuel", "ThermalMultiStart"),
        false,
    )
    _openapi_field_active_power_limits = _decode(
        MinMax,
        _required(_openapi_object, "active_power_limits", "ThermalMultiStart"),
        false,
    )
    ...
    _openapi_field_ramp_limits =
        ...
        ABSENT
    _openapi_field_power_trajectory =
        haskey(_openapi_object, "power_trajectory") ?
        _decode(
            Union{Absent, Nothing, StartUpShutDown},
            _openapi_object["power_trajectory"],
            false,
        ) : ABSENT
    _openapi_field_time_limits =
        ...
        ABSENT
    _openapi_field_start_time_limits =
        haskey(_openapi_object, "start_time_limits") ?
        _decode(
            Union{Absent, Nothing, StartUpStages},
            _openapi_object["start_time_limits"],
            false,
        ) : ABSENT
    _openapi_field_start_types = _decode(
        Int64,
        _required(_openapi_object, "start_types", "ThermalMultiStart"),
        false,
    )
    _openapi_field_operation_cost = _decode(
        ThermalMultiStartOperationCost,
        _required(_openapi_object, "operation_cost", "ThermalMultiStart"),
        false,
    )
    _openapi_field_base_power = _decode(
        Float64,
        _required(_openapi_object, "base_power", "ThermalMultiStart"),
        false,
    )
    _openapi_field_power_units = _decode(
        UnitSystem,
        _required(_openapi_object, "power_units", "ThermalMultiStart"),
        false,
    )
    ...
    return ThermalMultiStart(;
        ...
        power_trajectory=_openapi_field_power_trajectory,
        time_limits=_openapi_field_time_limits,
        start_time_limits=_openapi_field_start_time_limits,
        start_types=_openapi_field_start_types,
...
function _encode_unvalidated(_openapi_value::ThermalMultiStart)
    ...
    _openapi_value.power_trajectory isa Absent || (
        _openapi_output["power_trajectory"] =
            _encode_unvalidated(_openapi_value.power_trajectory)
    )
    _openapi_value.time_limits isa Absent ||
        (_openapi_output["time_limits"] = _encode_unvalidated(_openapi_value.time_limits))
    _openapi_value.start_time_limits isa Absent || (
        _openapi_output["start_time_limits"] =
            _encode_unvalidated(_openapi_value.start_time_limits)
    )
    _openapi_value.start_types isa Absent ||
        (_openapi_output["start_types"] = _encode_unvalidated(_openapi_value.start_types))
...
function _form_fields(_openapi_value::ThermalMultiStart)
    ...
    _openapi_value.power_trajectory isa Absent ||
        push!(_openapi_output, "power_trajectory" => _openapi_value.power_trajectory)
    _openapi_value.time_limits isa Absent ||
        push!(_openapi_output, "time_limits" => _openapi_value.time_limits)
    _openapi_value.start_time_limits isa Absent ||
        push!(_openapi_output, "start_time_limits" => _openapi_value.start_time_limits)
    _openapi_value.start_types isa Absent ||
        push!(_openapi_output, "start_types" => _openapi_value.start_types)
    _openapi_value.operation_cost isa Absent ||
