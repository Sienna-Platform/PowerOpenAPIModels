...
function _decode(::Type{ThermalMultiStart}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart"), _openapi_raw, "decoding ThermalMultiStart"; direction = :neutral)
...
function _encode(_openapi_value::ThermalMultiStart)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart"), _openapi_output, "encoding ThermalMultiStart"; direction = :neutral)
end
