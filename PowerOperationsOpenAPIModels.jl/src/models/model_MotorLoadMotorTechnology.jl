...
function _decode(::Type{MotorLoadMotorTechnology}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/MotorLoad/properties/motor_technology"), value, "decoding MotorLoadMotorTechnology"; direction = :neutral)
...
function _encode(value::MotorLoadMotorTechnology)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/MotorLoad/properties/motor_technology"), output, "encoding MotorLoadMotorTechnology"; direction = :neutral)
end
