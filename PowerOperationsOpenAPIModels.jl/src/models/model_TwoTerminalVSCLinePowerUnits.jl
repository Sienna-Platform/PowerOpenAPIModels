...
function _decode(::Type{TwoTerminalVSCLinePowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/power_units"), value, "decoding TwoTerminalVSCLinePowerUnits"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLinePowerUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/power_units"), output, "encoding TwoTerminalVSCLinePowerUnits"; direction = :neutral)
end
