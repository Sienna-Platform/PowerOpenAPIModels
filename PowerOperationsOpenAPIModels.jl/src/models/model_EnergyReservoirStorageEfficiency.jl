...
function _decode(::Type{EnergyReservoirStorageEfficiency}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/EnergyReservoirStorage/properties/efficiency"), _openapi_raw, "decoding EnergyReservoirStorageEfficiency"; direction = :neutral)
...
function _encode(_openapi_value::EnergyReservoirStorageEfficiency)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/EnergyReservoirStorage/properties/efficiency"), _openapi_output, "encoding EnergyReservoirStorageEfficiency"; direction = :neutral)
end
