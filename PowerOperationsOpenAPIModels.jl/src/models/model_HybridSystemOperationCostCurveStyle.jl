"""
    HybridSystemOperationCostCurveStyle
...
"""
struct HybridSystemOperationCostCurveStyle <: EnumAPIModel
    value::Int64
    function HybridSystemOperationCostCurveStyle(value::Int64)
        value in (0, 1, 2) || throw(
            ArgumentError(
                "invalid HybridSystemOperationCostCurveStyle value $(repr(value))",
            ),
        )
        return new(value)
    end
end
_decode(::Type{HybridSystemOperationCostCurveStyle}, value) =
    _decode(HybridSystemOperationCostCurveStyle, value, true)
function _decode(
    ::Type{HybridSystemOperationCostCurveStyle},
    value,
    ...
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/HybridSystem/properties/operation_cost/properties/curve_style",
        ),
        value,
        "decoding HybridSystemOperationCostCurveStyle";
        direction=:neutral,
    )
...
function _encode(value::HybridSystemOperationCostCurveStyle)
    ...
    return _validate_schema(
        ...
        output,
        "encoding HybridSystemOperationCostCurveStyle";
        direction=:neutral,
    )
end
