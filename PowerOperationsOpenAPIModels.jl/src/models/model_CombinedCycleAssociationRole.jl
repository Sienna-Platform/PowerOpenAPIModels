...
function _decode(::Type{CombinedCycleAssociationRole}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/CombinedCycleAssociation/properties/role"), value, "decoding CombinedCycleAssociationRole"; direction = :neutral)
...
function _encode(value::CombinedCycleAssociationRole)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/CombinedCycleAssociation/properties/role"), output, "encoding CombinedCycleAssociationRole"; direction = :neutral)
end
