...
function _decode(::Type{GroupReserveVariable}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/GroupReserve/properties/variable"), _openapi_raw, "decoding GroupReserveVariable"; direction = :neutral)
...
function _encode(_openapi_value::GroupReserveVariable)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/GroupReserve/properties/variable"), _openapi_output, "encoding GroupReserveVariable"; direction = :neutral)
end
