...
function _decode(::Type{TwoWindingTransformerAdmittanceUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoWindingTransformer/properties/admittance_units"), value, "decoding TwoWindingTransformerAdmittanceUnits"; direction = :neutral)
...
function _encode(value::TwoWindingTransformerAdmittanceUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoWindingTransformer/properties/admittance_units"), output, "encoding TwoWindingTransformerAdmittanceUnits"; direction = :neutral)
end
