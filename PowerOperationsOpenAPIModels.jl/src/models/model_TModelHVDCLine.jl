...
function _decode(::Type{TModelHVDCLine}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-a047858efa8bb2c42e03.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "TModelHVDCLine"), false)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "TModelHVDCLine"), false)
    _openapi_field_available =
        _decode(Bool, _required(_openapi_object, "available", "TModelHVDCLine"), false)
    ...
    _openapi_field_r =
        _decode(Float64, _required(_openapi_object, "r", "TModelHVDCLine"), false)
    _openapi_field_l =
...
function _encode_unvalidated(_openapi_value::TModelHVDCLine)
