...
function _decode(::Type{TransmissionInterface}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "TransmissionInterface"), false)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "TransmissionInterface"), false)
...
function _encode_unvalidated(_openapi_value::TransmissionInterface)
    ...
    _openapi_value.active_power_flow_limits isa Absent || (
        _openapi_output["active_power_flow_limits"] =
            _encode_unvalidated(_openapi_value.active_power_flow_limits)
    )
    _openapi_value.violation_penalty isa Absent || (
        _openapi_output["violation_penalty"] =
            _encode_unvalidated(_openapi_value.violation_penalty)
    )
    _openapi_value.direction_mapping isa Absent || (
        _openapi_output["direction_mapping"] =
            _encode_unvalidated(_openapi_value.direction_mapping)
    )
