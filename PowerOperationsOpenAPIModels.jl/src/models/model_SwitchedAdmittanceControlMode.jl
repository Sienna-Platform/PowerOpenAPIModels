...
function _decode(::Type{SwitchedAdmittanceControlMode}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/SwitchedAdmittance/properties/control_mode"), value, "decoding SwitchedAdmittanceControlMode"; direction = :neutral)
...
function _encode(value::SwitchedAdmittanceControlMode)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/SwitchedAdmittance/properties/control_mode"), output, "encoding SwitchedAdmittanceControlMode"; direction = :neutral)
end
