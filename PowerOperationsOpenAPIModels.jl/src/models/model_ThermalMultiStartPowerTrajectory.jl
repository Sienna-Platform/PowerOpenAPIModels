...
function _decode(::Type{ThermalMultiStartPowerTrajectory}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/power_trajectory"), _openapi_raw, "decoding ThermalMultiStartPowerTrajectory"; direction = :neutral)
...
function _encode(_openapi_value::ThermalMultiStartPowerTrajectory)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/power_trajectory"), _openapi_output, "encoding ThermalMultiStartPowerTrajectory"; direction = :neutral)
end
