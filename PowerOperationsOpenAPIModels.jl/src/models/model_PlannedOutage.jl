...
function _decode(::Type{PlannedOutage}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/PlannedOutage"), _openapi_raw, "decoding PlannedOutage"; direction = :neutral)
...
function _encode(_openapi_value::PlannedOutage)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/PlannedOutage"), _openapi_output, "encoding PlannedOutage"; direction = :neutral)
end
