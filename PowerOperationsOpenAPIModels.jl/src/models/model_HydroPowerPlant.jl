...
function _decode(::Type{HydroPowerPlant}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPowerPlant"), _openapi_raw, "decoding HydroPowerPlant"; direction = :neutral)
...
function _encode(_openapi_value::HydroPowerPlant)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPowerPlant"), _openapi_output, "encoding HydroPowerPlant"; direction = :neutral)
end
