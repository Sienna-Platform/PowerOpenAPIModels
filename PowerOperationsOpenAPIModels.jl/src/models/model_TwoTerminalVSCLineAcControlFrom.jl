...
function _decode(::Type{TwoTerminalVSCLineAcControlFrom}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/ac_control_from"), value, "decoding TwoTerminalVSCLineAcControlFrom"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineAcControlFrom)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/ac_control_from"), output, "encoding TwoTerminalVSCLineAcControlFrom"; direction = :neutral)
end
