...
function _decode(::Type{RenewableDispatchReactivePowerLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/reactive_power_limits"), _openapi_raw, "decoding RenewableDispatchReactivePowerLimits"; direction = :neutral)
...
function _encode(_openapi_value::RenewableDispatchReactivePowerLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/RenewableDispatch/properties/reactive_power_limits"), _openapi_output, "encoding RenewableDispatchReactivePowerLimits"; direction = :neutral)
end
