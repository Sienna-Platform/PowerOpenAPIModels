...
function _decode(::Type{TwoTerminalVSCLineSetpointVoltageUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/setpoint_voltage_units"), value, "decoding TwoTerminalVSCLineSetpointVoltageUnits"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineSetpointVoltageUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/setpoint_voltage_units"), output, "encoding TwoTerminalVSCLineSetpointVoltageUnits"; direction = :neutral)
end
