...
function _decode(::Type{HydroDispatchOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/operation_cost"), value, "decoding HydroDispatchOperationCost"; direction = :neutral)
...
function _encode(value::HydroDispatchOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/operation_cost"), output, "encoding HydroDispatchOperationCost"; direction = :neutral)
end
