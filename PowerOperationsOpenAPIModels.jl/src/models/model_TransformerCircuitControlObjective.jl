...
function _decode(::Type{TransformerCircuitControlObjective}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransformerCircuit/properties/control_objective"), value, "decoding TransformerCircuitControlObjective"; direction = :neutral)
...
function _encode(value::TransformerCircuitControlObjective)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransformerCircuit/properties/control_objective"), output, "encoding TransformerCircuitControlObjective"; direction = :neutral)
end
