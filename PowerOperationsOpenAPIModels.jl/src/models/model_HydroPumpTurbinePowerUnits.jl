...
function _decode(::Type{HydroPumpTurbinePowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/power_units"), value, "decoding HydroPumpTurbinePowerUnits"; direction = :neutral)
...
function _encode(value::HydroPumpTurbinePowerUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/power_units"), output, "encoding HydroPumpTurbinePowerUnits"; direction = :neutral)
end
