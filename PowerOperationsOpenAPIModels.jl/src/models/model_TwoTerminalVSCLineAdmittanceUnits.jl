...
function _decode(::Type{TwoTerminalVSCLineAdmittanceUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/admittance_units"), value, "decoding TwoTerminalVSCLineAdmittanceUnits"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineAdmittanceUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/admittance_units"), output, "encoding TwoTerminalVSCLineAdmittanceUnits"; direction = :neutral)
end
