...
function _decode(::Type{HybridSystemPowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HybridSystem/properties/power_units"), value, "decoding HybridSystemPowerUnits"; direction = :neutral)
    return HybridSystemPowerUnits(_decode(String, value, _openapi_validate))
end
function _encode(value::HybridSystemPowerUnits)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HybridSystem/properties/power_units"), output, "encoding HybridSystemPowerUnits"; direction = :neutral)
end
