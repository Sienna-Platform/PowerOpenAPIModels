...
function _decode(::Type{DiscreteControlledACBranchNormalBranchStatus}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DiscreteControlledACBranch/properties/normal_branch_status"), value, "decoding DiscreteControlledACBranchNormalBranchStatus"; direction = :neutral)
...
function _encode(value::DiscreteControlledACBranchNormalBranchStatus)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DiscreteControlledACBranch/properties/normal_branch_status"), output, "encoding DiscreteControlledACBranchNormalBranchStatus"; direction = :neutral)
end
