...
function _decode(::Type{SourceOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/Source/properties/operation_cost"), value, "decoding SourceOperationCost"; direction = :neutral)
    ...
    selected = get(Dict(
        "IMPORTEXPORT" => (ImportExportCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ImportExportCost")),
        ...
        "ImportExportCost" => (ImportExportCost, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ImportExportCost")),
...
function _encode(value::SourceOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/Source/properties/operation_cost"), output, "encoding SourceOperationCost"; direction = :neutral)
end
