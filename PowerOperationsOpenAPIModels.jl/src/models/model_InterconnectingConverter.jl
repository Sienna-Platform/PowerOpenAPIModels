...
function _decode(::Type{InterconnectingConverter}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter"), _openapi_raw, "decoding InterconnectingConverter"; direction = :neutral)
...
function _encode(_openapi_value::InterconnectingConverter)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterconnectingConverter"), _openapi_output, "encoding InterconnectingConverter"; direction = :neutral)
end
