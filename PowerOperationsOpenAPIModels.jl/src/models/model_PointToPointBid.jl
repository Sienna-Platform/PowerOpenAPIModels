...
function _decode(::Type{PointToPointBid}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/PointToPointBid"), _openapi_raw, "decoding PointToPointBid"; direction = :neutral)
...
function _encode(_openapi_value::PointToPointBid)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/PointToPointBid"), _openapi_output, "encoding PointToPointBid"; direction = :neutral)
end
