...
function _decode(::Type{TwoTerminalVSCLineAcControlTo}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/ac_control_to"), value, "decoding TwoTerminalVSCLineAcControlTo"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineAcControlTo)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/ac_control_to"), output, "encoding TwoTerminalVSCLineAcControlTo"; direction = :neutral)
end
