...
"""
Base.@kwdef struct ServiceAssociation <: APIModel
    service_id::Int64
    entity_id::Int64
...
function _decode(::Type{ServiceAssociation}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-c7c762fe44027ca5e1da.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding ServiceAssociation";
        direction=:neutral,
    )
...
function _form_fields(_openapi_value::ServiceAssociation)
    ...
    _openapi_value.service_id isa Absent ||
        push!(_openapi_output, "service_id" => _openapi_value.service_id)
    _openapi_value.entity_id isa Absent ||
