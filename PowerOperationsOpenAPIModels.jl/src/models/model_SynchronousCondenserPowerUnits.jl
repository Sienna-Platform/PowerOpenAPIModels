...
function _decode(::Type{SynchronousCondenserPowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/SynchronousCondenser/properties/power_units"), value, "decoding SynchronousCondenserPowerUnits"; direction = :neutral)
...
function _encode(value::SynchronousCondenserPowerUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/SynchronousCondenser/properties/power_units"), output, "encoding SynchronousCondenserPowerUnits"; direction = :neutral)
end
