...
function _decode(::Type{HydroDispatchPowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/power_units"), value, "decoding HydroDispatchPowerUnits"; direction = :neutral)
    return HydroDispatchPowerUnits(_decode(String, value, _openapi_validate))
end
function _encode(value::HydroDispatchPowerUnits)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/power_units"), output, "encoding HydroDispatchPowerUnits"; direction = :neutral)
end
