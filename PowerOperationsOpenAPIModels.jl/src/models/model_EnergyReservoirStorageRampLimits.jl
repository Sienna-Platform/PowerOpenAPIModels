...
function _decode(::Type{EnergyReservoirStorageRampLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/EnergyReservoirStorage/properties/ramp_limits"), _openapi_raw, "decoding EnergyReservoirStorageRampLimits"; direction = :neutral)
...
function _encode(_openapi_value::EnergyReservoirStorageRampLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/EnergyReservoirStorage/properties/ramp_limits"), _openapi_output, "encoding EnergyReservoirStorageRampLimits"; direction = :neutral)
end
