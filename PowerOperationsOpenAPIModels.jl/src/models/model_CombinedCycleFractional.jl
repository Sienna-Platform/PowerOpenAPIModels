...
function _decode(::Type{CombinedCycleFractional}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/CombinedCycleFractional"), _openapi_raw, "decoding CombinedCycleFractional"; direction = :neutral)
    _openapi_object = _object(_openapi_raw, "CombinedCycleFractional")
    _openapi_field_configuration = _decode(CombinedCycleConfiguration, _required(_openapi_object, "configuration", "CombinedCycleFractional"), _openapi_validate)
...
function _encode(_openapi_value::CombinedCycleFractional)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/CombinedCycleFractional"), _openapi_output, "encoding CombinedCycleFractional"; direction = :neutral)
end
