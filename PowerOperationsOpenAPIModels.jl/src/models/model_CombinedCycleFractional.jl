...
_decode(::Type{CombinedCycleFractional}, value) =
    _decode(CombinedCycleFractional, value, true)
function _decode(::Type{CombinedCycleFractional}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "CombinedCycleFractional"), false)
...
function _encode_unvalidated(_openapi_value::CombinedCycleFractional)
