...
function _decode(::Type{TransformerCircuitControlledQuantityLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransformerCircuit/properties/controlled_quantity_limits"), _openapi_raw, "decoding TransformerCircuitControlledQuantityLimits"; direction = :neutral)
...
function _encode(_openapi_value::TransformerCircuitControlledQuantityLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransformerCircuit/properties/controlled_quantity_limits"), _openapi_output, "encoding TransformerCircuitControlledQuantityLimits"; direction = :neutral)
end
