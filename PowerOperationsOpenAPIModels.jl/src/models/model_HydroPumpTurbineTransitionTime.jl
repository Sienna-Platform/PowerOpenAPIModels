...
function _decode(::Type{HydroPumpTurbineTransitionTime}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/transition_time"), _openapi_raw, "decoding HydroPumpTurbineTransitionTime"; direction = :neutral)
...
function _encode(_openapi_value::HydroPumpTurbineTransitionTime)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/transition_time"), _openapi_output, "encoding HydroPumpTurbineTransitionTime"; direction = :neutral)
end
