...
function _decode(::Type{BilateralTransactionConfirmation}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/BilateralTransaction/properties/confirmation"), value, "decoding BilateralTransactionConfirmation"; direction = :neutral)
...
function _encode(value::BilateralTransactionConfirmation)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/BilateralTransaction/properties/confirmation"), output, "encoding BilateralTransactionConfirmation"; direction = :neutral)
end
