...
function _decode(::Type{ThermalMultiStartCommitmentMode}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/commitment_mode"), value, "decoding ThermalMultiStartCommitmentMode"; direction = :neutral)
...
function _encode(value::ThermalMultiStartCommitmentMode)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/commitment_mode"), output, "encoding ThermalMultiStartCommitmentMode"; direction = :neutral)
end
