...
function _decode(::Type{HydroDispatchPrimeMoverType}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/prime_mover_type"), value, "decoding HydroDispatchPrimeMoverType"; direction = :neutral)
...
function _encode(value::HydroDispatchPrimeMoverType)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroDispatch/properties/prime_mover_type"), output, "encoding HydroDispatchPrimeMoverType"; direction = :neutral)
end
