...
function _decode(::Type{DCBusVoltageLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DCBus/properties/voltage_limits"), _openapi_raw, "decoding DCBusVoltageLimits"; direction = :neutral)
...
function _encode(_openapi_value::DCBusVoltageLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/DCBus/properties/voltage_limits"), _openapi_output, "encoding DCBusVoltageLimits"; direction = :neutral)
end
