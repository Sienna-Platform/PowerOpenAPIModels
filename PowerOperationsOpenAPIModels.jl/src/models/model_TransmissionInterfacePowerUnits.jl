...
function _decode(::Type{TransmissionInterfacePowerUnits}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransmissionInterface/properties/power_units"), value, "decoding TransmissionInterfacePowerUnits"; direction = :neutral)
...
function _encode(value::TransmissionInterfacePowerUnits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TransmissionInterface/properties/power_units"), output, "encoding TransmissionInterfacePowerUnits"; direction = :neutral)
end
