...
function _decode(::Type{TwoTerminalVSCLineReactivePowerLimitsFrom}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/reactive_power_limits_from"), _openapi_raw, "decoding TwoTerminalVSCLineReactivePowerLimitsFrom"; direction = :neutral)
...
function _encode(_openapi_value::TwoTerminalVSCLineReactivePowerLimitsFrom)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/reactive_power_limits_from"), _openapi_output, "encoding TwoTerminalVSCLineReactivePowerLimitsFrom"; direction = :neutral)
end
