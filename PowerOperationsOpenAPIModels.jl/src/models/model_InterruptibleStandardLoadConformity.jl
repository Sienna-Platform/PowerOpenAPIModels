...
function _decode(::Type{InterruptibleStandardLoadConformity}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptibleStandardLoad/properties/conformity"), value, "decoding InterruptibleStandardLoadConformity"; direction = :neutral)
...
function _encode(value::InterruptibleStandardLoadConformity)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptibleStandardLoad/properties/conformity"), output, "encoding InterruptibleStandardLoadConformity"; direction = :neutral)
end
