...
function _decode(::Type{TwoTerminalVSCLineConverterLossFromFunctionData}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/converter_loss_from/properties/function_data"), value, "decoding TwoTerminalVSCLineConverterLossFromFunctionData"; direction = :neutral)
...
function _encode(value::TwoTerminalVSCLineConverterLossFromFunctionData)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/TwoTerminalVSCLine/properties/converter_loss_from/properties/function_data"), output, "encoding TwoTerminalVSCLineConverterLossFromFunctionData"; direction = :neutral)
end
