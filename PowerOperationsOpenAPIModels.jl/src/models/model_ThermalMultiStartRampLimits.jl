...
function _decode(::Type{ThermalMultiStartRampLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/ramp_limits"), _openapi_raw, "decoding ThermalMultiStartRampLimits"; direction = :neutral)
...
function _encode(_openapi_value::ThermalMultiStartRampLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThermalMultiStart/properties/ramp_limits"), _openapi_output, "encoding ThermalMultiStartRampLimits"; direction = :neutral)
end
