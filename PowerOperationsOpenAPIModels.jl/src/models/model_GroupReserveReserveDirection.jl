...
function _decode(::Type{GroupReserveReserveDirection}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/GroupReserve/properties/reserve_direction"), value, "decoding GroupReserveReserveDirection"; direction = :neutral)
...
function _encode(value::GroupReserveReserveDirection)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/GroupReserve/properties/reserve_direction"), output, "encoding GroupReserveReserveDirection"; direction = :neutral)
end
