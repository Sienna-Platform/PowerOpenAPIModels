...
function _decode(::Type{InterruptiblePowerLoadOperationCost}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptiblePowerLoad/properties/operation_cost"), value, "decoding InterruptiblePowerLoadOperationCost"; direction = :neutral)
...
function _encode(value::InterruptiblePowerLoadOperationCost)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptiblePowerLoad/properties/operation_cost"), output, "encoding InterruptiblePowerLoadOperationCost"; direction = :neutral)
end
