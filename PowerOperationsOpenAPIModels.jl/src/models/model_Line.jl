...
function _decode(::Type{Line}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/Line"), _openapi_raw, "decoding Line"; direction = :neutral)
...
function _encode(_openapi_value::Line)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/Line"), _openapi_output, "encoding Line"; direction = :neutral)
end
