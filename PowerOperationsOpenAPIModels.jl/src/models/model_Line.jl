...
"""
Base.@kwdef struct Line <: APIModel
    id::Int64
    name::String
    available::Bool
    ...
    b::Union{Absent, FromTo, Nothing} = ABSENT
    rating::Float64
...
function _decode(::Type{Line}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-93f12fc3d1be3038d3a1.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding Line";
    ...
    _openapi_field_id = _decode(Int64, _required(_openapi_object, "id", "Line"), false)
    _openapi_field_name = _decode(String, _required(_openapi_object, "name", "Line"), false)
    _openapi_field_available =
        _decode(Bool, _required(_openapi_object, "available", "Line"), false)
    _openapi_field_active_power_flow =
        _decode(Float64, _required(_openapi_object, "active_power_flow", "Line"), false)
    _openapi_field_reactive_power_flow =
        _decode(Float64, _required(_openapi_object, "reactive_power_flow", "Line"), false)
    _openapi_field_arc = _decode(Int64, _required(_openapi_object, "arc", "Line"), false)
    _openapi_field_r = _decode(Float64, _required(_openapi_object, "r", "Line"), false)
    _openapi_field_x = _decode(Float64, _required(_openapi_object, "x", "Line"), false)
    _openapi_field_base_power =
        _decode(Float64, _required(_openapi_object, "base_power", "Line"), false)
    _openapi_field_power_units =
        _decode(UnitSystem, _required(_openapi_object, "power_units", "Line"), false)
    ...
    _openapi_field_b =
        haskey(_openapi_object, "b") ?
        _decode(Union{Absent, FromTo, Nothing}, _openapi_object["b"], false) : ABSENT
    _openapi_field_rating =
        _decode(Float64, _required(_openapi_object, "rating", "Line"), false)
...
function _encode_unvalidated(_openapi_value::Line)
