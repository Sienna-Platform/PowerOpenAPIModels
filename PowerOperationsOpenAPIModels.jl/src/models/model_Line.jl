...
function _decode(::Type{Line}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-9484e43b1cf15a5aa59e.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding Line";
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "Line"), _openapi_validate)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "Line"), _openapi_validate)
    _openapi_field_available =
        _decode(Bool, _required(_openapi_object, "available", "Line"), _openapi_validate)
    _openapi_field_active_power_flow = _decode(
        Float64,
        _required(_openapi_object, "active_power_flow", "Line"),
        _openapi_validate,
    )
    _openapi_field_reactive_power_flow = _decode(
        Float64,
        _required(_openapi_object, "reactive_power_flow", "Line"),
        _openapi_validate,
    )
    _openapi_field_arc =
        _decode(Int64, _required(_openapi_object, "arc", "Line"), _openapi_validate)
    _openapi_field_r =
        _decode(Float64, _required(_openapi_object, "r", "Line"), _openapi_validate)
    _openapi_field_x =
        _decode(Float64, _required(_openapi_object, "x", "Line"), _openapi_validate)
    _openapi_field_base_power = _decode(
        Float64,
        _required(_openapi_object, "base_power", "Line"),
        _openapi_validate,
    )
    ...
    _openapi_field_b =
        ...
        _decode(Union{Absent, FromTo, Nothing}, _openapi_object["b"], _openapi_validate) :
        ABSENT
    _openapi_field_rating =
        _decode(Float64, _required(_openapi_object, "rating", "Line"), _openapi_validate)
    ...
    _openapi_field_angle_limits = _decode(
        MinMax,
        _required(_openapi_object, "angle_limits", "Line"),
        _openapi_validate,
    )
    _openapi_field_g =
