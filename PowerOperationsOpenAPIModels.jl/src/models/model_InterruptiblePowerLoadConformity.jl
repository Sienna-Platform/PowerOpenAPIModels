...
function _decode(::Type{InterruptiblePowerLoadConformity}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptiblePowerLoad/properties/conformity"), value, "decoding InterruptiblePowerLoadConformity"; direction = :neutral)
...
function _encode(value::InterruptiblePowerLoadConformity)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/InterruptiblePowerLoad/properties/conformity"), output, "encoding InterruptiblePowerLoadConformity"; direction = :neutral)
end
