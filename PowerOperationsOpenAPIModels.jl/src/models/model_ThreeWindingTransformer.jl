...
Base.@kwdef struct ThreeWindingTransformer <: APIModel
    ...
    shunt_location::Union{Absent, Nothing, ThreeWindingTransformerShuntLocation} = ABSENT
    additional_properties::Dict{String, Any} = Dict{String, Any}()
end
_decode(::Type{ThreeWindingTransformer}, value) =
    _decode(ThreeWindingTransformer, value, true)
function _decode(::Type{ThreeWindingTransformer}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-9bfcb20936c20a6d037b.json",
            pointer="",
        ),
        _openapi_raw,
        "decoding ThreeWindingTransformer";
        direction=:neutral,
    )
    ...
    return ThreeWindingTransformer(;
        ...
        primary_circuit=_openapi_field_primary_circuit,
        secondary_circuit=_openapi_field_secondary_circuit,
        tertiary_circuit=_openapi_field_tertiary_circuit,
        star_bus=_openapi_field_star_bus,
        parameter_units=_openapi_field_parameter_units,
        r_12=_openapi_field_r_12,
        x_12=_openapi_field_x_12,
        r_23=_openapi_field_r_23,
        x_23=_openapi_field_x_23,
        r_31=_openapi_field_r_31,
        x_31=_openapi_field_x_31,
        base_power_12=_openapi_field_base_power_12,
        base_power_23=_openapi_field_base_power_23,
        base_power_31=_openapi_field_base_power_31,
...
function _form_fields(_openapi_value::ThreeWindingTransformer)
    ...
    _openapi_value.primary_circuit isa Absent ||
        push!(_openapi_output, "primary_circuit" => _openapi_value.primary_circuit)
    _openapi_value.secondary_circuit isa Absent ||
        push!(_openapi_output, "secondary_circuit" => _openapi_value.secondary_circuit)
    _openapi_value.tertiary_circuit isa Absent ||
        push!(_openapi_output, "tertiary_circuit" => _openapi_value.tertiary_circuit)
    _openapi_value.star_bus isa Absent ||
        push!(_openapi_output, "star_bus" => _openapi_value.star_bus)
    _openapi_value.parameter_units isa Absent ||
    ...
    _openapi_value.base_power_12 isa Absent ||
        push!(_openapi_output, "base_power_12" => _openapi_value.base_power_12)
    _openapi_value.base_power_23 isa Absent ||
        push!(_openapi_output, "base_power_23" => _openapi_value.base_power_23)
    _openapi_value.base_power_31 isa Absent ||
        push!(_openapi_output, "base_power_31" => _openapi_value.base_power_31)
    _openapi_value.admittance_units isa Absent ||
