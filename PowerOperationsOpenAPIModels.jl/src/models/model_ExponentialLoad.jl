...
function _decode(::Type{ExponentialLoad}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-d106a786e07a865aec5d.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "ExponentialLoad"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "ExponentialLoad"),
        _openapi_validate,
    )
    _openapi_field_available = _decode(
        Bool,
        _required(_openapi_object, "available", "ExponentialLoad"),
        _openapi_validate,
    )
    _openapi_field_bus = _decode(
        Int64,
        _required(_openapi_object, "bus", "ExponentialLoad"),
        _openapi_validate,
    )
    ...
    _openapi_field_alpha = _decode(
        Float64,
        _required(_openapi_object, "alpha", "ExponentialLoad"),
        _openapi_validate,
    )
    _openapi_field_beta = _decode(
        Float64,
        _required(_openapi_object, "beta", "ExponentialLoad"),
        _openapi_validate,
    )
    _openapi_field_base_power = _decode(
        Float64,
        _required(_openapi_object, "base_power", "ExponentialLoad"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::ExponentialLoad)
    ...
    _openapi_value.beta isa Absent ||
        (_openapi_output["beta"] = _encode(_openapi_value.beta))
