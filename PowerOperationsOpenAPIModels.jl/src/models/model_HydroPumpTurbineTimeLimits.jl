...
function _decode(::Type{HydroPumpTurbineTimeLimits}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/time_limits"), _openapi_raw, "decoding HydroPumpTurbineTimeLimits"; direction = :neutral)
...
function _encode(_openapi_value::HydroPumpTurbineTimeLimits)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/HydroPumpTurbine/properties/time_limits"), _openapi_output, "encoding HydroPumpTurbineTimeLimits"; direction = :neutral)
end
