...
function _decode(::Type{FACTSControlDeviceShuntControlType}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice/properties/shunt_control_type"), value, "decoding FACTSControlDeviceShuntControlType"; direction = :neutral)
...
function _encode(value::FACTSControlDeviceShuntControlType)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/FACTSControlDevice/properties/shunt_control_type"), output, "encoding FACTSControlDeviceShuntControlType"; direction = :neutral)
end
