...
function _decode(::Type{ThreeWindingTransformerShuntLocation}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThreeWindingTransformerShuntLocation"), value, "decoding ThreeWindingTransformerShuntLocation"; direction = :neutral)
...
function _encode(value::ThreeWindingTransformerShuntLocation)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-1068b1dda553e6e25b3b.json", pointer = "/components/schemas/ThreeWindingTransformerShuntLocation"), output, "encoding ThreeWindingTransformerShuntLocation"; direction = :neutral)
end
