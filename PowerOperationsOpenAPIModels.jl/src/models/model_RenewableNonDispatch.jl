...
function _decode(::Type{RenewableNonDispatch}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-8ba4c48c1375f928eed0.json",
            pointer="",
        ),
        _openapi_raw,
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "RenewableNonDispatch"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "RenewableNonDispatch"),
        _openapi_validate,
    )
    ...
    _openapi_field_bus = _decode(
        Int64,
        _required(_openapi_object, "bus", "RenewableNonDispatch"),
        _openapi_validate,
    )
