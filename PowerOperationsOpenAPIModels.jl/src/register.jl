...
function __init__()
    ...
    InfrastructureCoreOpenAPIModels.register_model_type!(ReactivePowerSharing)
    ...
    InfrastructureCoreOpenAPIModels.register_model_type!(VoltageControlAssociation)
    InfrastructureCoreOpenAPIModels.register_model_type!(VoltageDroopControl)
    return nothing
end
