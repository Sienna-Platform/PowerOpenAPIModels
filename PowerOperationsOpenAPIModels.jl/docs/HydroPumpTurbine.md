...
**`efficiency`** | **`Union{Absent,TurbinePump,Nothing}`** | Turbine/Pump efficiency [0, 1.0]. | [optional]
...
**`must_run`** | **`Union{Absent,Bool,Nothing}`** | Whether the unit must run (i.e., cannot be curtailed). | [optional]
...
**`prime_mover_type`** | **`Union{Absent,PrimeMovers,Nothing}`** | Prime mover technology according to EIA 923. | [optional]
