...
**`parameter_units`** | **`String`** | Unit basis for this circuit&#39;s impedance fields (r, x). | [optional] [default to "DEVICE_BASE"]
**`r`** | **`Float64`** | Circuit resistance. Units: per parameter_units — NATURAL_UNITS: ohm, DEVICE_BASE: pu . | [optional] [default to 0.0]
**`x`** | **`Float64`** | Circuit reactance. Units: per parameter_units — NATURAL_UNITS: ohm, DEVICE_BASE: pu . | [optional] [default to 0.0]
