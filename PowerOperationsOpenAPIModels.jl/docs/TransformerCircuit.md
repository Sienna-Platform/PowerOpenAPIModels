...
**`parameter_units`** | **`String`** | Unit basis for this circuit&#39;s impedance fields (r, x). | [optional] [default to "COMPONENT_BASE"]
**`r`** | **`Float64`** | Circuit resistance. Units: per parameter_units — NATURAL_UNITS: ohm, COMPONENT_BASE: pu . | [optional] [default to 0.0]
**`x`** | **`Float64`** | Circuit reactance. Units: per parameter_units — NATURAL_UNITS: ohm, COMPONENT_BASE: pu . | [optional] [default to 0.0]
...
**`rating`** | **`Float64`** | Thermal rating. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [optional] [default to nothing]
**`rating_b`** | **`Float64`** | Second current rating. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [optional] [default to nothing]
**`rating_c`** | **`Float64`** | Third current rating. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [optional] [default to nothing]
**`active_power_flow`** | **`Float64`** | Initial condition of active power flow through this circuit. Units: per power_units — NATURAL_UNITS: MW, COMPONENT_BASE: pu . | [optional] [default to 0.0]
**`reactive_power_flow`** | **`Float64`** | Initial condition of reactive power flow through this circuit. Units: per power_units — NATURAL_UNITS: MVAr, COMPONENT_BASE: pu . | [optional] [default to 0.0]
