...
**`active_power`** | **`Float64`** | Initial steady-state active power demand. A positive value indicates power consumption. Units: MW. | [default to nothing]
**`reactive_power`** | **`Float64`** | Initial steady-state reactive power demand. A positive value indicates reactive power consumption. Units: MVAr. | [default to nothing]
