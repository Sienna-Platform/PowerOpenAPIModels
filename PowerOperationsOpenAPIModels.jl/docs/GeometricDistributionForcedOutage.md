...
**`mean_time_to_recovery`** | **`Int64`** | Mean time elapsed between a failure and the return to service, as a whole number of minutes. Units: min. | [optional] [default to 0]
