...
**`outage_schedule`** | **`String`** |  | [default to nothing]
...
**`identifier`** | **`String`** | Optional user-supplied identifier for the outage, such as a name or a block id. Null when not set. | [optional] [default to nothing]
