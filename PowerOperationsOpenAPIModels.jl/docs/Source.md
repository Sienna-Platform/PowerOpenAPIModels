...
**`parameter_units`** | **`String`** | Unit basis for this source&#39;s impedance fields (R_th, X_th). | [optional] [default to "DEVICE_BASE"]
**`R_th`** | **`Float64`** | Source Thevenin resistance. Units: per parameter_units — NATURAL_UNITS: ohm, DEVICE_BASE: pu . | [optional] [default to 0.0]
**`X_th`** | **`Float64`** | Source Thevenin reactance. Units: per parameter_units — NATURAL_UNITS: ohm, DEVICE_BASE: pu . | [optional] [default to 0.0]
