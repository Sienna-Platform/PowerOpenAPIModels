...
**`active_power`** | **`Float64`** | Initial active power set point of the unit. For power flow, this is the steady state operating point of the system. For production cost modeling, this may or may not be used as the initial starting point for the solver, depending on the solver used. Units: MW. | [optional] [default to 0.0]
**`reactive_power`** | **`Float64`** | Initial reactive power set point of the unit. Units: MVAr. | [optional] [default to 0.0]
...
**`parameter_units`** | **`String`** | Unit basis for this source&#39;s impedance fields (R_th, X_th). | [optional] [default to "SYSTEM_BASE"]
**`R_th`** | **`Float64`** | Source Thevenin resistance. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [optional] [default to 0.0]
**`X_th`** | **`Float64`** | Source Thevenin reactance. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [optional] [default to 0.0]
