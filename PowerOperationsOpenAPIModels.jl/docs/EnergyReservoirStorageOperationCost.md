...
------------ | ------------- | ------------- | -------------
**value** | This is a oneOf model. The value must be exactly one of the following types: ImportExportTimeSeriesCost, MarketBidCost, MarketBidTimeSeriesCost, StorageCost | Operating cost of storage. or MarketBidCost | [optional] 
