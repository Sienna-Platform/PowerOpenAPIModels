...
**`requirement`** | **`Float64`** | The value of required reserves. Units: MW. | [optional] [default to 0.0]
**`variable`** | [**`*CostCurve`**](CostCurve.md) |  | [optional] [default to nothing]
**`sustained_time`** | **`Float64`** | The time reserve contribution must be sustained at a specified level. Units: min. | [optional] [default to 60.0]
