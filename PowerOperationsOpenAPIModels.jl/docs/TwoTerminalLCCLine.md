...
**`r`** | **`Float64`** | Series resistance of the DC line. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [default to nothing]
...
**`dc_voltage_units`** | **`String`** | Unit basis for the DC voltage fields (scheduled_dc_voltage, switch_mode_voltage, min_compounding_voltage). SYSTEM_BASE: per-unit on the bus base voltage. NATURAL_UNITS: kV. | [optional] [default to "NATURAL_UNITS"]
**`scheduled_dc_voltage`** | **`Float64`** | Scheduled compounded DC voltage. By default this parameter is the scheduled DC voltage in the inverter bus. This parameter must not be specified in per-unit. Units: kV. Units: per dc_voltage_units — SYSTEM_BASE: pu, NATURAL_UNITS: kV . | [default to nothing]
...
**`rectifier_rc`** | **`Float64`** | Rectifier commutating transformer resistance per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [default to nothing]
**`rectifier_xc`** | **`Float64`** | Rectifier commutating transformer reactance per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [default to nothing]
...
**`inverter_rc`** | **`Float64`** | Inverter commutating transformer resistance per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [default to nothing]
**`inverter_xc`** | **`Float64`** | Inverter commutating transformer reactance per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [default to nothing]
...
**`rectifier_capacitor_reactance`** | **`Float64`** | Commutating rectifier capacitor reactance magnitude per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [optional] [default to 0.0]
...
**`inverter_capacitor_reactance`** | **`Float64`** | Commutating inverter capacitor reactance magnitude per bridge. Per-unit on system base. Units: pu. Units: per parameter_units — SYSTEM_BASE: pu, NATURAL_UNITS: ohm . | [optional] [default to 0.0]
...
**`loss`** | [**`*TwoTerminalLoss1`**](TwoTerminalLoss1.md) |  | [optional] [default to nothing]
