...
**`time_at_status`** | **`Float64`** | Time the generator has been on or off, as indicated by &#x60;status&#x60;. default is psy const INFINITE_TIME &#x3D; 1e4 Units: h. | [optional] [default to 10000.0]
