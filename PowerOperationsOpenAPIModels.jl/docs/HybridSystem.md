...
**`interconnection_impedance`** | [**`*ComplexNumber`**](ComplexNumber.md) |  | [optional] [default to nothing]
**`interconnection_rating`** | **`Float64`** | Maximum rating of the hybrid system&#39;s interconnection with the transmission network. Set to &#x60;null&#x60; if not applicable. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [optional] [default to nothing]
