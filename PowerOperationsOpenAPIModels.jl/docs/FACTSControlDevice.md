...
**`voltage_setpoint_units`** | **`String`** | Unit basis for voltage_setpoint. SYSTEM_BASE (pu) is PSS/E RAW native (VSET). | [optional] [default to "SYSTEM_BASE"]
**`voltage_setpoint`** | **`Float64`** | Voltage setpoint at the sending end bus in kV, it has to be a &#x60;PV&#x60; bus. Units: kV. Units: per voltage_setpoint_units — SYSTEM_BASE: pu, NATURAL_UNITS: kV . | [default to nothing]
