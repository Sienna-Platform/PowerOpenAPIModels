...
**`max_reactive_power`** | **`Union{Absent,Float64,Nothing}`** | Independent maximum reactive power ceiling: the device limit is the lesser of this value and the current/susceptance law. Non-binding at the 9999.0 default. Units: per power_units — NATURAL_UNITS: MVAr, COMPONENT_BASE: pu . | [optional]
