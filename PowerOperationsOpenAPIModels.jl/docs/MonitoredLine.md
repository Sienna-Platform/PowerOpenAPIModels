...
**`reactive_power_flow`** | **`Float64`** | Initial condition of reactive power flow on the line. Units: per power_units — NATURAL_UNITS: MVAr, COMPONENT_BASE: pu . | [default to nothing]
...
**`parameter_units`** | **`String`** | Unit basis for this line&#39;s impedance and shunt admittance fields (r, x, b, g). | [optional] [default to "COMPONENT_BASE"]
**`b`** | [**`*FromTo`**](FromTo.md) |  | [default to nothing]
**`flow_limits`** | [**`*FromToToFrom`**](FromToToFrom.md) |  | [default to nothing]
**`rating`** | **`Float64`** | Thermal rating. Flow through the transformer must be between -&#x60;rating&#x60; and &#x60;rating&#x60;. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [default to nothing]
