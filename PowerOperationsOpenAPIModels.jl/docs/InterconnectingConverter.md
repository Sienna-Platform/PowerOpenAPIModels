...
------------ | ------------- | ------------- | -------------
**`ac_control`** | **`Union{Absent,VSCACControlModes,Nothing}`** | AC-side control mode of the converter. | [optional]
...
**`dc_control`** | **`Union{Absent,VSCDCControlModes,Nothing}`** | DC-side control mode of the converter. | [optional]
...
**`voltage_setpoint_units`** | **`Union{Absent,VoltageUnitBasis,Nothing}`** | Unit basis for the DC/AC voltage setpoints. | [optional]
