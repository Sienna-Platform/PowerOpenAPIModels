...
**`rating`** | **`Float64`** | Thermal rating. Flow on the branch must be between -&#x60;rating&#x60; and &#x60;rating&#x60;. Units: per power_units — NATURAL_UNITS: MVA, COMPONENT_BASE: pu . | [default to nothing]
