...
**`time_frame`** | **`Float64`** | The saturation time frame that a participating device must provide its reserve contribution. Units: min. | [default to nothing]
**`requirement`** | **`Float64`** | The value of required reserves. Units: MW. | [default to nothing]
**`sustained_time`** | **`Float64`** | The time reserve contribution must be sustained at a specified level. Units: s. | [optional] [default to 3600.0]
