...
**`function_data`** | **`FunctionData`** | Only TIME_SERIES_LINEAR, TIME_SERIES_QUADRATIC, or TIME_SERIES_PIECEWISE_LINEAR is admissible; other variants are rejected. | [required]
