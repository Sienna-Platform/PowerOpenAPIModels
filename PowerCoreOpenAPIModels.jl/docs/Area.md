...
**`peak_active_power`** | **`Float64`** | Peak active power in the area. Units: per power_units — NATURAL_UNITS: MW, COMPONENT_BASE: pu . | [optional] [default to 0.0]
**`peak_reactive_power`** | **`Float64`** | Peak reactive power in the area. Units: per power_units — NATURAL_UNITS: MVAr, COMPONENT_BASE: pu . | [optional] [default to 0.0]
