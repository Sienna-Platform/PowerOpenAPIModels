...
**`available`** | **`Bool`** | Whether the component is connected and online (true) or disconnected, offline, or down (false). Distinct from the ISOLATED enum value. | [required]
