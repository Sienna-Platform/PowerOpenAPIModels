...
"""
Base.@kwdef struct TimeSeriesIncrementalCurve <: APIModel
    curve_type::String = "TIME_SERIES_INCREMENTAL"
...
_decode(::Type{TimeSeriesIncrementalCurve}, value) =
    _decode(TimeSeriesIncrementalCurve, value, true)
function _decode(::Type{TimeSeriesIncrementalCurve}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding TimeSeriesIncrementalCurve";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "TimeSeriesIncrementalCurve")
    _openapi_field_curve_type = _decode(
        String,
        _required(_openapi_object, "curve_type", "TimeSeriesIncrementalCurve"),
        false,
    )
    _openapi_field_function_data = _decode(
        FunctionData,
        _required(_openapi_object, "function_data", "TimeSeriesIncrementalCurve"),
        false,
    )
    ...
    return TimeSeriesIncrementalCurve(;
        ...
        initial_input_association_id=_openapi_field_initial_input_association_id,
        input_at_zero_association_id=_openapi_field_input_at_zero_association_id,
        additional_properties=_openapi_additional_properties,
    )
end
function _encode_unvalidated(_openapi_value::TimeSeriesIncrementalCurve)
...
_encode(_openapi_value::TimeSeriesIncrementalCurve) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-0936a17371037c3b813d.json",
        pointer="/\$defs/TimeSeriesIncrementalCurve",
    ...
    "encoding TimeSeriesIncrementalCurve";
    direction=:neutral,
)
...
function _form_fields(_openapi_value::TimeSeriesIncrementalCurve)
    ...
    _openapi_value.initial_input_association_id isa Absent || push!(
        _openapi_output,
        "initial_input_association_id" => _openapi_value.initial_input_association_id,
    )
    _openapi_value.input_at_zero_association_id isa Absent || push!(
        _openapi_output,
        "input_at_zero_association_id" => _openapi_value.input_at_zero_association_id,
    )
