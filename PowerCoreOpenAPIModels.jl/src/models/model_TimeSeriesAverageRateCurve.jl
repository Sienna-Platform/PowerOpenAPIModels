...
"""
Base.@kwdef struct TimeSeriesAverageRateCurve <: APIModel
    curve_type::String = "TIME_SERIES_AVERAGE_RATE"
...
_decode(::Type{TimeSeriesAverageRateCurve}, value) =
    _decode(TimeSeriesAverageRateCurve, value, true)
function _decode(::Type{TimeSeriesAverageRateCurve}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding TimeSeriesAverageRateCurve";
        direction=:neutral,
    )
