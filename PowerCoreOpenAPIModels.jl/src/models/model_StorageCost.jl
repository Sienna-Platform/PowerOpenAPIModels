...
function _decode(::Type{StorageCost}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_fixed =
        _decode(Float64, _required(_openapi_object, "fixed", "StorageCost"), false)
    _openapi_field_shut_down =
        _decode(Float64, _required(_openapi_object, "shut_down", "StorageCost"), false)
...
function _encode_unvalidated(_openapi_value::StorageCost)
    ...
    _openapi_value.charge_variable_cost isa Absent || (
        _openapi_output["charge_variable_cost"] =
            _encode_unvalidated(_openapi_value.charge_variable_cost)
    )
    _openapi_value.discharge_variable_cost isa Absent || (
        _openapi_output["discharge_variable_cost"] =
            _encode_unvalidated(_openapi_value.discharge_variable_cost)
    )
    ...
    _openapi_value.energy_shortage_cost isa Absent || (
        _openapi_output["energy_shortage_cost"] =
            _encode_unvalidated(_openapi_value.energy_shortage_cost)
    )
    _openapi_value.energy_surplus_cost isa Absent || (
        _openapi_output["energy_surplus_cost"] =
            _encode_unvalidated(_openapi_value.energy_surplus_cost)
    )
