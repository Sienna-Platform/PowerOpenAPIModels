...
const _property_types_LoadCost = Dict{Symbol,Type}(Symbol("cost_type")=>Union{Nothing, String}, Symbol("fixed")=>Union{Nothing, Float64}, Symbol("variable")=>Union{Nothing, CostCurve}, )
