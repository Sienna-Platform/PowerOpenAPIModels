...
function _encode(_openapi_value::StartUpShutDown)
    ...
    _openapi_value.shutdown isa Absent ||
        (_openapi_output["shutdown"] = _encode(_openapi_value.shutdown))
    _openapi_value.startup isa Absent ||
        (_openapi_output["startup"] = _encode(_openapi_value.startup))
