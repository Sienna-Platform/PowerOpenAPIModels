...
Base.@kwdef mutable struct MarketBidCost <: OpenAPI.APIModel
    ...
    function MarketBidCost(cost_type, minimum_energy_offer, start_up, shut_down, incremental_offer_curves, decremental_offer_curves, ancillary_service_offers, incremental_slope, decremental_slope, curve_style, )
        o = new(cost_type, minimum_energy_offer, start_up, shut_down, incremental_offer_curves, decremental_offer_curves, ancillary_service_offers, incremental_slope, decremental_slope, curve_style, )
        OpenAPI.validate_properties(o)
        return o
    end
end # type MarketBidCost

const _property_types_MarketBidCost = Dict{Symbol,Type}(Symbol("cost_type")=>Union{Nothing, String}, Symbol("minimum_energy_offer")=>Union{Nothing, InputOutputCurve}, Symbol("start_up")=>Union{Nothing, StartUpStages}, Symbol("shut_down")=>Union{Nothing, InputOutputCurve}, Symbol("incremental_offer_curves")=>Union{Nothing, CostCurve}, Symbol("decremental_offer_curves")=>Union{Nothing, CostCurve}, Symbol("ancillary_service_offers")=>Union{Nothing, Vector{Int64}}, Symbol("incremental_slope")=>Union{Nothing, Bool}, Symbol("decremental_slope")=>Union{Nothing, Bool}, Symbol("curve_style")=>Union{Nothing, Int64}, )
