...
Only TIME_SERIES_LINEAR, TIME_SERIES_QUADRATIC, or TIME_SERIES_PIECEWISE_LINEAR is admissible here; the static variants and TIME_SERIES_PIECEWISE_STEP are invalid and rejected by the consuming constructor.
    ...
    FunctionData1(; value=nothing)
"""
mutable struct FunctionData1 <: OpenAPI.OneOfAPIModel
    ...
    FunctionData1() = new()
    FunctionData1(value) = new(value)
end # type FunctionData1

function OpenAPI.property_type(::Type{ FunctionData1 }, name::Symbol, json::Dict{String,Any})
    ...
    throw(OpenAPI.ValidationException("Invalid discriminator value: $discriminator for FunctionData1"))
end
