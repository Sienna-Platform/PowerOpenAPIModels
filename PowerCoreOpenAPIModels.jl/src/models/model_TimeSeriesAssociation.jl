...
Metadata linking a time series dataset to a component.
    ...
    - units::String : Unit string for the series values; must be a unit from the Core/units.json vocabulary allowed for &#x60;quantity_kind&#x60;. Absent when the series declares no unit, and meaningless on its own when &#x60;unit_system&#x60; is a per-unit basis, where the values are dimensionless.
...
Base.@kwdef mutable struct TimeSeriesAssociation <: OpenAPI.APIModel
    ...
    function TimeSeriesAssociation(id, time_series_type, initial_timestamp, resolution, horizon, interval, window_count, length, name, owner_id, owner_type, owner_category, features, element_type, units, quantity_kind, unit_system, application_data, )
        o = new(id, time_series_type, initial_timestamp, resolution, horizon, interval, window_count, length, name, owner_id, owner_type, owner_category, features, element_type, units, quantity_kind, unit_system, application_data, )
        OpenAPI.validate_properties(o)
        return o
    end
end # type TimeSeriesAssociation

const _property_types_TimeSeriesAssociation = Dict{Symbol,String}(Symbol("id")=>"Int64", Symbol("time_series_type")=>"String", Symbol("initial_timestamp")=>"ZonedDateTime", Symbol("resolution")=>"String", Symbol("horizon")=>"String", Symbol("interval")=>"String", Symbol("window_count")=>"Int64", Symbol("length")=>"Int64", Symbol("name")=>"String", Symbol("owner_id")=>"Int64", Symbol("owner_type")=>"String", Symbol("owner_category")=>"String", Symbol("features")=>"Vector{Dict{String, FeatureValue}}", Symbol("element_type")=>"String", Symbol("units")=>"String", Symbol("quantity_kind")=>"String", Symbol("unit_system")=>"String", Symbol("application_data")=>"String", )
...
function OpenAPI.validate_properties(o::TimeSeriesAssociation)
    ...
    OpenAPI.validate_property(TimeSeriesAssociation, Symbol("quantity_kind"), o.quantity_kind)
