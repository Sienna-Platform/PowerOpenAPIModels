...
function _encode(_openapi_value::IncrementalCurve)
    ...
    _openapi_value.initial_input isa Absent ||
        (_openapi_output["initial_input"] = _encode(_openapi_value.initial_input))
