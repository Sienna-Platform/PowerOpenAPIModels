...
"""
struct MarketBidCostCurveStyle <: EnumAPIModel
    value::Int64
    function MarketBidCostCurveStyle(value::Int64)
        value in (0, 1, 2) ||
            throw(ArgumentError("invalid MarketBidCostCurveStyle value $(repr(value))"))
        return new(value)
    end
end
_decode(::Type{MarketBidCostCurveStyle}, value) =
    _decode(MarketBidCostCurveStyle, value, true)
function _decode(::Type{MarketBidCostCurveStyle}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/MarketBidCost/properties/curve_style",
        ),
        value,
        "decoding MarketBidCostCurveStyle";
        direction=:neutral,
    )
...
function _encode(value::MarketBidCostCurveStyle)
    ...
    return _validate_schema(
        ...
        output,
        "encoding MarketBidCostCurveStyle";
        direction=:neutral,
    )
end
