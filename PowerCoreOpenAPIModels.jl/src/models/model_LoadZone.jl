...
function _decode(::Type{LoadZone}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "LoadZone"), _openapi_validate)
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "LoadZone"), _openapi_validate)
    _openapi_field_peak_active_power = _decode(
        Float64,
        _required(_openapi_object, "peak_active_power", "LoadZone"),
        _openapi_validate,
    )
    ...
    _openapi_field_base_power = _decode(
        Float64,
        _required(_openapi_object, "base_power", "LoadZone"),
        _openapi_validate,
    )
