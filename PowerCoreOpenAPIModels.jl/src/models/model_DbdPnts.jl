...
"""
Base.@kwdef struct DbdPnts <: APIModel
...
function _decode(::Type{DbdPnts}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_dbd1 =
        haskey(_openapi_object, "dbd1") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["dbd1"], false) : ABSENT
    _openapi_field_dbd2 =
        haskey(_openapi_object, "dbd2") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["dbd2"], false) : ABSENT
    ...
    return DbdPnts(;
        dbd1=_openapi_field_dbd1,
        dbd2=_openapi_field_dbd2,
        additional_properties=_openapi_additional_properties,
    )
end
function _encode_unvalidated(_openapi_value::DbdPnts)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.dbd1 isa Absent ||
        (_openapi_output["dbd1"] = _encode_unvalidated(_openapi_value.dbd1))
    _openapi_value.dbd2 isa Absent ||
        (_openapi_output["dbd2"] = _encode_unvalidated(_openapi_value.dbd2))
...
_encode(_openapi_value::DbdPnts) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-0936a17371037c3b813d.json",
        pointer="/\$defs/DbdPnts",
