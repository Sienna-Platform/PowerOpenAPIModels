...
Base.@kwdef struct FuelCurve <: APIModel
    ...
    variable_cost_type::String = "FUEL"
...
function _decode(::Type{FuelCurve}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_fuel_cost =
        haskey(_openapi_object, "fuel_cost") ?
        _decode(
    ...
    return FuelCurve(;
        ...
        fuel_cost_time_series=_openapi_field_fuel_cost_time_series,
        power_units=_openapi_field_power_units,
        startup_fuel_offtake=_openapi_field_startup_fuel_offtake,
...
function _form_fields(_openapi_value::FuelCurve)
    ...
    _openapi_value.fuel_cost isa Absent ||
        push!(_openapi_output, "fuel_cost" => _openapi_value.fuel_cost)
    _openapi_value.fuel_cost_time_series isa Absent || push!(
        _openapi_output,
        "fuel_cost_time_series" => _openapi_value.fuel_cost_time_series,
    )
    _openapi_value.power_units isa Absent ||
        push!(_openapi_output, "power_units" => _openapi_value.power_units)
    _openapi_value.startup_fuel_offtake isa Absent || push!(
        _openapi_output,
        "startup_fuel_offtake" => _openapi_value.startup_fuel_offtake,
    )
    _openapi_value.value_curve isa Absent ||
        push!(_openapi_output, "value_curve" => _openapi_value.value_curve)
    _openapi_value.variable_cost_type isa Absent ||
        push!(_openapi_output, "variable_cost_type" => _openapi_value.variable_cost_type)
    _openapi_value.vom_cost isa Absent ||
        push!(_openapi_output, "vom_cost" => _openapi_value.vom_cost)
