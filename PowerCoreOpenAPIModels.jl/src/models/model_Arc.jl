...
function _decode(::Type{Arc}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "Arc"), _openapi_validate)
    _openapi_field_from_id =
        _decode(Int64, _required(_openapi_object, "from_id", "Arc"), _openapi_validate)
    _openapi_field_to_id =
        _decode(Int64, _required(_openapi_object, "to_id", "Arc"), _openapi_validate)
