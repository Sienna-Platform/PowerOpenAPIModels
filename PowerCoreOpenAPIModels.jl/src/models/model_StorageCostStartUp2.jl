Base.@kwdef struct StorageCostStartUp2 <: APIModel
...
function _decode(::Type{StorageCostStartUp2}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/StorageCost/properties/start_up/oneOf/1",
        ),
        _openapi_raw,
        "decoding StorageCostStartUp2";
        direction=:neutral,
    )
