...
function _decode(::Type{ChargeDischarge}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_charge =
        _decode(Float64, _required(_openapi_object, "charge", "ChargeDischarge"), false)
    _openapi_field_discharge =
        _decode(Float64, _required(_openapi_object, "discharge", "ChargeDischarge"), false)
...
function _encode_unvalidated(_openapi_value::ChargeDischarge)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.charge isa Absent ||
        (_openapi_output["charge"] = _encode_unvalidated(_openapi_value.charge))
    _openapi_value.discharge isa Absent ||
        (_openapi_output["discharge"] = _encode_unvalidated(_openapi_value.discharge))
...
_encode(_openapi_value::ChargeDischarge) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-0936a17371037c3b813d.json",
        pointer="/\$defs/ChargeDischarge",
