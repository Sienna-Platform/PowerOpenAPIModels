...
function _decode(::Type{ProbabilisticOwnerCategory}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Probabilistic/properties/owner_category"), value, "decoding ProbabilisticOwnerCategory"; direction = :neutral)
...
function _encode(value::ProbabilisticOwnerCategory)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Probabilistic/properties/owner_category"), output, "encoding ProbabilisticOwnerCategory"; direction = :neutral)
end
