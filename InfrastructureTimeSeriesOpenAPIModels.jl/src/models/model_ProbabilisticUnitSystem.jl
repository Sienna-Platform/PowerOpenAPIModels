...
function _decode(::Type{ProbabilisticUnitSystem}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Probabilistic/properties/unit_system"), value, "decoding ProbabilisticUnitSystem"; direction = :neutral)
    return ProbabilisticUnitSystem(_decode(String, value, _openapi_validate))
end
function _encode(value::ProbabilisticUnitSystem)
    output = _encode(value.value)
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Probabilistic/properties/unit_system"), output, "encoding ProbabilisticUnitSystem"; direction = :neutral)
end
