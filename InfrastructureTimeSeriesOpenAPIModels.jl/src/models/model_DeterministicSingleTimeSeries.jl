...
function _decode(::Type{DeterministicSingleTimeSeries}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/DeterministicSingleTimeSeries"), _openapi_raw, "decoding DeterministicSingleTimeSeries"; direction = :neutral)
...
function _encode(_openapi_value::DeterministicSingleTimeSeries)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/DeterministicSingleTimeSeries"), _openapi_output, "encoding DeterministicSingleTimeSeries"; direction = :neutral)
end
