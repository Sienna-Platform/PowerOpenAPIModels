...
"""
Base.@kwdef struct TimeSeriesAssociation4 <: APIModel
...
_decode(::Type{TimeSeriesAssociation4}, value) =
    _decode(TimeSeriesAssociation4, value, true)
function _decode(::Type{TimeSeriesAssociation4}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TimeSeriesAssociation/oneOf/3",
        ),
        _openapi_raw,
        "decoding TimeSeriesAssociation4";
        direction=:neutral,
    )
    ...
    _openapi_field_association_id = _decode(
        Int64,
        _required(_openapi_object, "association_id", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    ...
    _openapi_field_count = _decode(
        Int64,
        _required(_openapi_object, "count", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    ...
    _openapi_field_element_shape = _decode(
        Vector{Int64},
        _required(_openapi_object, "element_shape", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_element_type = _decode(
        String,
        _required(_openapi_object, "element_type", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_features = _decode(
        TimeSeriesFeatures,
        _required(_openapi_object, "features", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_horizon = _decode(
        String,
        _required(_openapi_object, "horizon", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_initial_timestamp = _decode(
        Dates.DateTime,
        _required(_openapi_object, "initial_timestamp", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_interval = _decode(
        String,
        _required(_openapi_object, "interval", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_owner_category = _decode(
        OwnerCategory,
        _required(_openapi_object, "owner_category", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_owner_id = _decode(
        Int64,
        _required(_openapi_object, "owner_id", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    _openapi_field_owner_type = _decode(
        String,
        _required(_openapi_object, "owner_type", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    ...
    _openapi_field_resolution = _decode(
        String,
        _required(_openapi_object, "resolution", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    ...
    _openapi_field_time_series_type = _decode(
        String,
        _required(_openapi_object, "time_series_type", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
    ...
    _openapi_field_uri = _decode(
        String,
        _required(_openapi_object, "uri", "TimeSeriesAssociation4"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::TimeSeriesAssociation4)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TimeSeriesAssociation4";
        direction=:neutral,
    )
end
