...
"""
Base.@kwdef struct TimeSeriesAssociation3 <: APIModel
...
_decode(::Type{TimeSeriesAssociation3}, value) =
    _decode(TimeSeriesAssociation3, value, true)
function _decode(::Type{TimeSeriesAssociation3}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TimeSeriesAssociation/oneOf/2",
        ),
        _openapi_raw,
        "decoding TimeSeriesAssociation3";
        direction=:neutral,
    )
    ...
    _openapi_field_association_id = _decode(
        Int64,
        _required(_openapi_object, "association_id", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    ...
    _openapi_field_count = _decode(
        Int64,
        _required(_openapi_object, "count", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    ...
    _openapi_field_element_shape = _decode(
        Vector{Int64},
        _required(_openapi_object, "element_shape", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_element_type = _decode(
        String,
        _required(_openapi_object, "element_type", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_features = _decode(
        TimeSeriesFeatures,
        _required(_openapi_object, "features", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_horizon = _decode(
        String,
        _required(_openapi_object, "horizon", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_initial_timestamp = _decode(
        Dates.DateTime,
        _required(_openapi_object, "initial_timestamp", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_interval = _decode(
        String,
        _required(_openapi_object, "interval", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_owner_category = _decode(
        OwnerCategory,
        _required(_openapi_object, "owner_category", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_owner_id = _decode(
        Int64,
        _required(_openapi_object, "owner_id", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    _openapi_field_owner_type = _decode(
        String,
        _required(_openapi_object, "owner_type", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    ...
    _openapi_field_resolution = _decode(
        String,
        _required(_openapi_object, "resolution", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    ...
    _openapi_field_time_series_type = _decode(
        String,
        _required(_openapi_object, "time_series_type", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
    ...
    _openapi_field_uri = _decode(
        String,
        _required(_openapi_object, "uri", "TimeSeriesAssociation3"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::TimeSeriesAssociation3)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TimeSeriesAssociation3";
        direction=:neutral,
    )
end
