...
function _decode(::Type{DeterministicOwnerCategory}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Deterministic/properties/owner_category"), value, "decoding DeterministicOwnerCategory"; direction = :neutral)
...
function _encode(value::DeterministicOwnerCategory)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/Deterministic/properties/owner_category"), output, "encoding DeterministicOwnerCategory"; direction = :neutral)
end
