...
function _decode(::Type{NonSequentialTimeSeries}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_uri =
        _decode(String, _required(_openapi_object, "uri", "NonSequentialTimeSeries"), false)
    _openapi_field_timestamps_uri =
        haskey(_openapi_object, "timestamps_uri") ?
        _decode(Union{Absent, Nothing, String}, _openapi_object["timestamps_uri"], false) :
        ABSENT
...
function _encode_unvalidated(_openapi_value::NonSequentialTimeSeries)
    ...
    _openapi_value.timestamps_uri isa Absent || (
        _openapi_output["timestamps_uri"] =
            _encode_unvalidated(_openapi_value.timestamps_uri)
    )
