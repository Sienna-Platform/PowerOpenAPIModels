...
"""
Base.@kwdef struct TimeSeriesAssociation1 <: APIModel
...
_decode(::Type{TimeSeriesAssociation1}, value) =
    _decode(TimeSeriesAssociation1, value, true)
function _decode(::Type{TimeSeriesAssociation1}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TimeSeriesAssociation/oneOf/0",
        ),
        _openapi_raw,
        "decoding TimeSeriesAssociation1";
        direction=:neutral,
    )
    ...
    _openapi_field_association_id = _decode(
        Int64,
        _required(_openapi_object, "association_id", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    ...
    _openapi_field_element_shape = _decode(
        Vector{Int64},
        _required(_openapi_object, "element_shape", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_element_type = _decode(
        String,
        _required(_openapi_object, "element_type", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_features = _decode(
        TimeSeriesFeatures,
        _required(_openapi_object, "features", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_initial_timestamp = _decode(
        Dates.DateTime,
        _required(_openapi_object, "initial_timestamp", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_length = _decode(
        Int64,
        _required(_openapi_object, "length", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_owner_category = _decode(
        OwnerCategory,
        _required(_openapi_object, "owner_category", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_owner_id = _decode(
        Int64,
        _required(_openapi_object, "owner_id", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    _openapi_field_owner_type = _decode(
        String,
        _required(_openapi_object, "owner_type", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    ...
    _openapi_field_resolution = _decode(
        String,
        _required(_openapi_object, "resolution", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    ...
    _openapi_field_time_series_type = _decode(
        String,
        _required(_openapi_object, "time_series_type", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
    ...
    _openapi_field_uri = _decode(
        String,
        _required(_openapi_object, "uri", "TimeSeriesAssociation1"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::TimeSeriesAssociation1)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TimeSeriesAssociation1";
        direction=:neutral,
    )
end
