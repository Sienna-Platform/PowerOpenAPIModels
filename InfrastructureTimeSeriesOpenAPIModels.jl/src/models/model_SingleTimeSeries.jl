...
function _decode(::Type{SingleTimeSeries}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/SingleTimeSeries"), _openapi_raw, "decoding SingleTimeSeries"; direction = :neutral)
...
function _encode(_openapi_value::SingleTimeSeries)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/SingleTimeSeries"), _openapi_output, "encoding SingleTimeSeries"; direction = :neutral)
end
