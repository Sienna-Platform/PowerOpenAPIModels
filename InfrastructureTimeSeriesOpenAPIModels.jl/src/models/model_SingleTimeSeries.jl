...
function _decode(::Type{SingleTimeSeries}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_owner_id =
        _decode(Int64, _required(_openapi_object, "owner_id", "SingleTimeSeries"), false)
    _openapi_field_owner_type =
        _decode(String, _required(_openapi_object, "owner_type", "SingleTimeSeries"), false)
    ...
    _openapi_field_name =
        _decode(String, _required(_openapi_object, "name", "SingleTimeSeries"), false)
    ...
    _openapi_field_uri =
        _decode(String, _required(_openapi_object, "uri", "SingleTimeSeries"), false)
    ...
    _openapi_field_resolution =
        _decode(String, _required(_openapi_object, "resolution", "SingleTimeSeries"), false)
    _openapi_field_length =
        _decode(Int64, _required(_openapi_object, "length", "SingleTimeSeries"), false)
...
function _encode_unvalidated(_openapi_value::SingleTimeSeries)
    ...
    _openapi_value.length isa Absent ||
        (_openapi_output["length"] = _encode_unvalidated(_openapi_value.length))
...
_encode(_openapi_value::SingleTimeSeries) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-b4bee6c783951387cd54.json",
        pointer="",
