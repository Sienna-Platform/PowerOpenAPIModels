...
function _decode(::Type{DeterministicSingleTimeSeriesUnitSystem}, value, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/DeterministicSingleTimeSeries/properties/unit_system"), value, "decoding DeterministicSingleTimeSeriesUnitSystem"; direction = :neutral)
...
function _encode(value::DeterministicSingleTimeSeriesUnitSystem)
    ...
    return _validate_schema(_SPEC, (resource = "https://openapi.invalid/schema/root-d907e2d1c7ab387eab6d.json", pointer = "/components/schemas/DeterministicSingleTimeSeries/properties/unit_system"), output, "encoding DeterministicSingleTimeSeriesUnitSystem"; direction = :neutral)
end
