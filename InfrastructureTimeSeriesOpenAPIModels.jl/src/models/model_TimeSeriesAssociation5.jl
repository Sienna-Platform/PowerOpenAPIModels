...
"""
Base.@kwdef struct TimeSeriesAssociation5 <: APIModel
...
_decode(::Type{TimeSeriesAssociation5}, value) =
    _decode(TimeSeriesAssociation5, value, true)
function _decode(::Type{TimeSeriesAssociation5}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/TimeSeriesAssociation/oneOf/4",
        ),
        _openapi_raw,
        "decoding TimeSeriesAssociation5";
        direction=:neutral,
    )
    ...
    _openapi_field_association_id = _decode(
        Int64,
        _required(_openapi_object, "association_id", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    _openapi_field_count = _decode(
        Int64,
        _required(_openapi_object, "count", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    _openapi_field_element_shape = _decode(
        Vector{Int64},
        _required(_openapi_object, "element_shape", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_element_type = _decode(
        String,
        _required(_openapi_object, "element_type", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_features = _decode(
        TimeSeriesFeatures,
        _required(_openapi_object, "features", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_horizon = _decode(
        String,
        _required(_openapi_object, "horizon", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_initial_timestamp = _decode(
        Dates.DateTime,
        _required(_openapi_object, "initial_timestamp", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_interval = _decode(
        String,
        _required(_openapi_object, "interval", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_name = _decode(
        String,
        _required(_openapi_object, "name", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_owner_category = _decode(
        OwnerCategory,
        _required(_openapi_object, "owner_category", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_owner_id = _decode(
        Int64,
        _required(_openapi_object, "owner_id", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_owner_type = _decode(
        String,
        _required(_openapi_object, "owner_type", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    _openapi_field_percentiles = _decode(
        Vector{Float64},
        _required(_openapi_object, "percentiles", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    _openapi_field_resolution = _decode(
        String,
        _required(_openapi_object, "resolution", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    _openapi_field_time_series_type = _decode(
        String,
        _required(_openapi_object, "time_series_type", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    _openapi_field_uri = _decode(
        String,
        _required(_openapi_object, "uri", "TimeSeriesAssociation5"),
        _openapi_validate,
    )
    ...
    return TimeSeriesAssociation5(;
        ...
        percentiles=_openapi_field_percentiles,
...
function _encode(_openapi_value::TimeSeriesAssociation5)
    ...
    return _validate_schema(
        ...
        _openapi_output,
        "encoding TimeSeriesAssociation5";
        direction=:neutral,
    )
end
...
function _form_fields(_openapi_value::TimeSeriesAssociation5)
    ...
    _openapi_value.percentiles isa Absent ||
        push!(_openapi_output, "percentiles" => _openapi_value.percentiles)
    _openapi_value.quantity_kind isa Absent ||
