...
**`scenario_count`** | **`Int64`** | Number of scenarios, one per leading axis entry of the stored array. Recorded explicitly here since this layer carries no array. | [required]
...
**`time_series_type`** | **`String`** | Discriminator, fixed to Scenarios for this schema. | [required]
