...
@doc raw"""SingleTimeSeries
A static time series on a regular grid: values at &#x60;initial_timestamp + k * resolution&#x60;. One of the six canonical time series types owned by InfrastructureSystems. This schema records the association and its metadata; the dense values live in the store named by &#x60;address&#x60;.
    ...
    - time_series_type::String : Discriminator. Fixed to SingleTimeSeries for this schema, pinned with &#x60;const&#x60; to match this repo&#39;s existing discriminators (Core/common.json&#39;s &#x60;curve_type&#x60;), which generate a plain string literal in both toolchains.
    ...
    - initial_timestamp::ZonedDateTime : First timestamp of the regular grid; every later step lands at &#x60;initial_timestamp + k * resolution&#x60;. Stored as an RFC3339 string and keeps nanoseconds, so a grid may be millisecond-spaced while being nanosecond-offset in its phase.
    - resolution::String : Cadence of the regular grid. Always present for a SingleTimeSeries, and part of the series&#39; identity.
...
Base.@kwdef mutable struct SingleTimeSeries <: OpenAPI.APIModel
    ...
    time_series_type::Union{Nothing, String} = "SingleTimeSeries"
    ...
    function SingleTimeSeries(id, owner_id, owner_type, owner_category, time_series_type, name, features, address, element_type, element_shape, units, quantity_kind, unit_system, component_field, application_data, initial_timestamp, resolution, length, )
        o = new(id, owner_id, owner_type, owner_category, time_series_type, name, features, address, element_type, element_shape, units, quantity_kind, unit_system, component_field, application_data, initial_timestamp, resolution, length, )
...
function OpenAPI.validate_properties(o::SingleTimeSeries)
    ...
    OpenAPI.validate_property(SingleTimeSeries, Symbol("time_series_type"), o.time_series_type)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("name"), o.name)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("features"), o.features)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("address"), o.address)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("element_type"), o.element_type)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("element_shape"), o.element_shape)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("units"), o.units)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("quantity_kind"), o.quantity_kind)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("unit_system"), o.unit_system)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("component_field"), o.component_field)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("application_data"), o.application_data)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("initial_timestamp"), o.initial_timestamp)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("resolution"), o.resolution)
    OpenAPI.validate_property(SingleTimeSeries, Symbol("length"), o.length)
end
...
function OpenAPI.validate_property(::Type{ SingleTimeSeries }, name::Symbol, val)
    ...
    if name === Symbol("owner_category")
        OpenAPI.validate_param(name, "SingleTimeSeries", :enum, val, ["Component", "SupplementalAttribute"])
    end


    if name === Symbol("time_series_type")
        OpenAPI.validate_param(name, "SingleTimeSeries", :enum, val, ["SingleTimeSeries"])
    end
    ...
    if name === Symbol("unit_system")
        OpenAPI.validate_param(name, "SingleTimeSeries", :enum, val, ["COMPONENT_BASE", "NATURAL_UNITS"])
    end
    ...
    if name === Symbol("initial_timestamp")
        OpenAPI.validate_param(name, "SingleTimeSeries", :format, val, "date-time")
    end


    if name === Symbol("length")
        OpenAPI.validate_param(name, "SingleTimeSeries", :minimum, val, 0, false)
    end
end
