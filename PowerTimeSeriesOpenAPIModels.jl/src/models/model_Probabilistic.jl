...
Base.@kwdef mutable struct Probabilistic <: OpenAPI.APIModel
    ...
    function Probabilistic(association_id, owner_id, owner_type, owner_category, time_series_type, name, features, uri, data_hash, element_type, element_shape, array_shape, units, quantity_kind, unit_system, time_reference, component_field, application_data, initial_timestamp, resolution, horizon, interval, count, percentiles, )
        o = new(association_id, owner_id, owner_type, owner_category, time_series_type, name, features, uri, data_hash, element_type, element_shape, array_shape, units, quantity_kind, unit_system, time_reference, component_field, application_data, initial_timestamp, resolution, horizon, interval, count, percentiles, )
        OpenAPI.validate_properties(o)
        return o
    end
end # type Probabilistic

const _property_types_Probabilistic = Dict{Symbol,Type}(Symbol("association_id")=>Union{Nothing, Int64}, Symbol("owner_id")=>Union{Nothing, Int64}, Symbol("owner_type")=>Union{Nothing, String}, Symbol("owner_category")=>Union{Nothing, String}, Symbol("time_series_type")=>Union{Nothing, String}, Symbol("name")=>Union{Nothing, String}, Symbol("features")=>Union{Nothing, Dict{String, TimeSeriesFeatureValue}}, Symbol("uri")=>Union{Nothing, String}, Symbol("data_hash")=>Union{Nothing, String}, Symbol("element_type")=>Union{Nothing, String}, Symbol("element_shape")=>Union{Nothing, Vector{Int64}}, Symbol("array_shape")=>Union{Nothing, Vector{Int64}}, Symbol("units")=>Union{Nothing, String}, Symbol("quantity_kind")=>Union{Nothing, String}, Symbol("unit_system")=>Union{Nothing, String}, Symbol("time_reference")=>Union{Nothing, String}, Symbol("component_field")=>Union{Nothing, String}, Symbol("application_data")=>Union{Nothing, String}, Symbol("initial_timestamp")=>Union{Nothing, ZonedDateTime}, Symbol("resolution")=>Union{Nothing, String}, Symbol("horizon")=>Union{Nothing, String}, Symbol("interval")=>Union{Nothing, String}, Symbol("count")=>Union{Nothing, Int64}, Symbol("percentiles")=>Union{Nothing, Vector{Float64}}, )
OpenAPI.property_type(::Type{ Probabilistic }, name::Symbol) = _property_types_Probabilistic[name]
...
function OpenAPI.validate_properties(o::Probabilistic)
    OpenAPI.validate_property(Probabilistic, Symbol("association_id"), o.association_id)
    ...
    OpenAPI.validate_property(Probabilistic, Symbol("array_shape"), o.array_shape)
    ...
    OpenAPI.validate_property(Probabilistic, Symbol("time_reference"), o.time_reference)
