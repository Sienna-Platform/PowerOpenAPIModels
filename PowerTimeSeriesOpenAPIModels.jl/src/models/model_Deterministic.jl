...
A deterministic forecast: one horizon-length array per window, windows stepping by &#x60;interval&#x60;. One of the six canonical time series types owned by InfrastructureSystems. This schema records the association and its metadata; the dense values live in the store named by &#x60;address&#x60;.
...
function OpenAPI.validate_properties(o::Deterministic)
    ...
    OpenAPI.validate_property(Deterministic, Symbol("resolution"), o.resolution)
    OpenAPI.validate_property(Deterministic, Symbol("horizon"), o.horizon)
    OpenAPI.validate_property(Deterministic, Symbol("interval"), o.interval)
    OpenAPI.validate_property(Deterministic, Symbol("count"), o.count)
end
...
function OpenAPI.validate_property(::Type{ Deterministic }, name::Symbol, val)
    ...
    if name === Symbol("owner_category")
        OpenAPI.validate_param(name, "Deterministic", :enum, val, ["Component", "SupplementalAttribute"])
    end
    ...
    if name === Symbol("initial_timestamp")
        OpenAPI.validate_param(name, "Deterministic", :format, val, "date-time")
    end
    ...
    if name === Symbol("count")
        OpenAPI.validate_param(name, "Deterministic", :minimum, val, 0, false)
    end
end
