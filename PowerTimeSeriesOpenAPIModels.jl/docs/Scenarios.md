...
**`scenario_count`** | **`Int64`** | Number of scenarios, one per leading axis entry of the stored array. infrastore&#39;s catalog has no column for this and reads it off the array&#39;s shape; it is recorded explicitly here because this layer carries no array. | [default to nothing]
