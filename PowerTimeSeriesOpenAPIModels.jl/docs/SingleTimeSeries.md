...
**`initial_timestamp`** | **`ZonedDateTime`** | First timestamp of the regular grid; every later step lands at &#x60;initial_timestamp + k * resolution&#x60;. An RFC3339 string with at most 3 fractional-second digits: the store&#39;s floor is one millisecond, matching Julia&#39;s millisecond-precision DateTime. | [default to nothing]
