...
**`time_series_type`** | **`String`** | Discriminator. Fixed to Probabilistic for this schema, pinned with &#x60;const&#x60; to match this repo&#39;s existing discriminators (Core/common.json&#39;s &#x60;curve_type&#x60;), which generate a plain string literal in both toolchains. | [default to "Probabilistic"]
...
**`percentiles`** | **`Vector{Float64}`** | The percentiles this forecast carries, one per leading axis entry of the stored array. | [default to nothing]
