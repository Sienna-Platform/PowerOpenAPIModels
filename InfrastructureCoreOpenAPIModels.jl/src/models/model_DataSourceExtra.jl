...
"""
Base.@kwdef struct DataSourceExtra <: APIModel
...
function _decode(::Type{DataSourceExtra}, _openapi_raw, _openapi_validate::Bool)
    ...
    for (_openapi_key, _openapi_item) in _openapi_object
        ...
        _openapi_additional_properties[String(_openapi_key)] =
            _decode(String, _openapi_item, false)
    end
    return DataSourceExtra(; additional_properties=_openapi_additional_properties)
end
function _encode_unvalidated(_openapi_value::DataSourceExtra)
...
_encode(_openapi_value::DataSourceExtra) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-84b51e521c3e86885d35.json",
        pointer="/properties/extra",
