...
function _decode(::Type{FromTo}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        ...
        (
            ...
            pointer="/components/schemas/FromTo",
        ),
        _openapi_raw,
        "decoding FromTo";
        direction=:neutral,
    ...
    _openapi_field_from =
        ...
        _decode(
            ...
            _openapi_object["from"],
            _openapi_validate,
        ) : ABSENT
    _openapi_field_to =
        haskey(_openapi_object, "to") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["to"], _openapi_validate) :
        ABSENT
...
function _encode(_openapi_value::FromTo)
    ...
    _openapi_value.from isa Absent ||
        (_openapi_output["from"] = _encode(_openapi_value.from))
