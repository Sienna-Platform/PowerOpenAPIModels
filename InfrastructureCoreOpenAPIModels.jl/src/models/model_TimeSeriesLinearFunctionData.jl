...
"""
Base.@kwdef struct TimeSeriesLinearFunctionData <: APIModel
    association_id::Int64
    function_type::String = "TIME_SERIES_LINEAR"
    additional_properties::Dict{String, Any} = Dict{String, Any}()
end
_decode(::Type{TimeSeriesLinearFunctionData}, value) =
    _decode(TimeSeriesLinearFunctionData, value, true)
function _decode(
    ::Type{TimeSeriesLinearFunctionData},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding TimeSeriesLinearFunctionData";
        direction=:neutral,
    )
