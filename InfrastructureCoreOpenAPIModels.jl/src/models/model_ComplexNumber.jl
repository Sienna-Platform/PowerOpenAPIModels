...
function _decode(::Type{ComplexNumber}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_real =
        ...
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["real"], false) : ABSENT
    _openapi_field_imag =
        haskey(_openapi_object, "imag") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["imag"], false) : ABSENT
...
function _encode_unvalidated(_openapi_value::ComplexNumber)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.real isa Absent ||
        (_openapi_output["real"] = _encode_unvalidated(_openapi_value.real))
    _openapi_value.imag isa Absent ||
        (_openapi_output["imag"] = _encode_unvalidated(_openapi_value.imag))
