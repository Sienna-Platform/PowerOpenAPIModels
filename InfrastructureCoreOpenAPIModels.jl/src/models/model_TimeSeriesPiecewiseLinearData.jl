...
"""
Base.@kwdef struct TimeSeriesPiecewiseLinearData <: APIModel
    function_type::String = "TIME_SERIES_PIECEWISE_LINEAR"
    association_id::Int64
    additional_properties::Dict{String, Any} = Dict{String, Any}()
end
_decode(::Type{TimeSeriesPiecewiseLinearData}, value) =
    _decode(TimeSeriesPiecewiseLinearData, value, true)
function _decode(
    ::Type{TimeSeriesPiecewiseLinearData},
    _openapi_raw,
    ...
    _openapi_validate && _validate_schema(
        ...
        _openapi_raw,
        "decoding TimeSeriesPiecewiseLinearData";
        direction=:neutral,
    )
    _openapi_object = _object(_openapi_raw, "TimeSeriesPiecewiseLinearData")
    _openapi_field_function_type = _decode(
        String,
        _required(_openapi_object, "function_type", "TimeSeriesPiecewiseLinearData"),
        false,
    )
    _openapi_field_association_id = _decode(
        Int64,
        _required(_openapi_object, "association_id", "TimeSeriesPiecewiseLinearData"),
        false,
    )
...
function _encode_unvalidated(_openapi_value::TimeSeriesPiecewiseLinearData)
...
_encode(_openapi_value::TimeSeriesPiecewiseLinearData) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-50d5243393bb9d77da58.json",
        pointer="/\$defs/TimeSeriesPiecewiseLinearData",
    ...
    "encoding TimeSeriesPiecewiseLinearData";
    direction=:neutral,
)
