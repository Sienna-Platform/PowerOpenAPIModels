...
function _decode(::Type{IEEETurbineGov1}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "IEEETurbineGov1"), false)
    _openapi_field_k =
        _decode(Int64, _required(_openapi_object, "K", "IEEETurbineGov1"), false)
    _openapi_field_t1 =
        _decode(Int64, _required(_openapi_object, "T1", "IEEETurbineGov1"), false)
    _openapi_field_t2 =
        _decode(Float64, _required(_openapi_object, "T2", "IEEETurbineGov1"), false)
    _openapi_field_t3 =
        _decode(Float64, _required(_openapi_object, "T3", "IEEETurbineGov1"), false)
    _openapi_field_u0 =
        _decode(Float64, _required(_openapi_object, "U0", "IEEETurbineGov1"), false)
    _openapi_field_u_c =
        _decode(Float64, _required(_openapi_object, "U_c", "IEEETurbineGov1"), false)
    ...
    _openapi_field_t4 =
        _decode(Float64, _required(_openapi_object, "T4", "IEEETurbineGov1"), false)
    _openapi_field_k1 =
        _decode(Float64, _required(_openapi_object, "K1", "IEEETurbineGov1"), false)
    _openapi_field_k2 =
        _decode(Float64, _required(_openapi_object, "K2", "IEEETurbineGov1"), false)
    _openapi_field_t5 =
        _decode(Float64, _required(_openapi_object, "T5", "IEEETurbineGov1"), false)
    _openapi_field_k3 =
        _decode(Float64, _required(_openapi_object, "K3", "IEEETurbineGov1"), false)
    _openapi_field_k4 =
        _decode(Float64, _required(_openapi_object, "K4", "IEEETurbineGov1"), false)
    _openapi_field_t6 =
        _decode(Float64, _required(_openapi_object, "T6", "IEEETurbineGov1"), false)
    _openapi_field_k5 =
        _decode(Float64, _required(_openapi_object, "K5", "IEEETurbineGov1"), false)
    _openapi_field_k6 =
        _decode(Float64, _required(_openapi_object, "K6", "IEEETurbineGov1"), false)
    _openapi_field_t7 =
        _decode(Float64, _required(_openapi_object, "T7", "IEEETurbineGov1"), false)
    _openapi_field_k7 =
        _decode(Float64, _required(_openapi_object, "K7", "IEEETurbineGov1"), false)
    _openapi_field_k8 =
        _decode(Float64, _required(_openapi_object, "K8", "IEEETurbineGov1"), false)
...
function _encode_unvalidated(_openapi_value::IEEETurbineGov1)
    ...
    _openapi_value.u0 isa Absent ||
        (_openapi_output["U0"] = _encode_unvalidated(_openapi_value.u0))
    _openapi_value.u_c isa Absent ||
        (_openapi_output["U_c"] = _encode_unvalidated(_openapi_value.u_c))
    ...
    _openapi_value.k2 isa Absent ||
        (_openapi_output["K2"] = _encode_unvalidated(_openapi_value.k2))
    _openapi_value.t5 isa Absent ||
        (_openapi_output["T5"] = _encode_unvalidated(_openapi_value.t5))
    _openapi_value.k3 isa Absent ||
        (_openapi_output["K3"] = _encode_unvalidated(_openapi_value.k3))
    _openapi_value.k4 isa Absent ||
        (_openapi_output["K4"] = _encode_unvalidated(_openapi_value.k4))
    _openapi_value.t6 isa Absent ||
        (_openapi_output["T6"] = _encode_unvalidated(_openapi_value.t6))
    _openapi_value.k5 isa Absent ||
        (_openapi_output["K5"] = _encode_unvalidated(_openapi_value.k5))
    _openapi_value.k6 isa Absent ||
        (_openapi_output["K6"] = _encode_unvalidated(_openapi_value.k6))
    _openapi_value.t7 isa Absent ||
        (_openapi_output["T7"] = _encode_unvalidated(_openapi_value.t7))
    _openapi_value.k7 isa Absent ||
        (_openapi_output["K7"] = _encode_unvalidated(_openapi_value.k7))
    _openapi_value.k8 isa Absent ||
        (_openapi_output["K8"] = _encode_unvalidated(_openapi_value.k8))
...
_encode(_openapi_value::IEEETurbineGov1) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-cdf5e56e3fc6e79f7a91.json",
        pointer="",
