...
function _decode(::Type{AVRTypeI}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(Int64, _required(_openapi_object, "id", "AVRTypeI"), false)
    _openapi_field_ka =
        _decode(Float64, _required(_openapi_object, "Ka", "AVRTypeI"), false)
    _openapi_field_ke =
        _decode(Float64, _required(_openapi_object, "Ke", "AVRTypeI"), false)
    _openapi_field_kf =
        _decode(Float64, _required(_openapi_object, "Kf", "AVRTypeI"), false)
    _openapi_field_ta =
        _decode(Float64, _required(_openapi_object, "Ta", "AVRTypeI"), false)
    _openapi_field_te =
        _decode(Float64, _required(_openapi_object, "Te", "AVRTypeI"), false)
    _openapi_field_tf =
        _decode(Float64, _required(_openapi_object, "Tf", "AVRTypeI"), false)
    _openapi_field_tr =
        _decode(Float64, _required(_openapi_object, "Tr", "AVRTypeI"), false)
    _openapi_field_va_lim =
        _decode(MinMax, _required(_openapi_object, "Va_lim", "AVRTypeI"), false)
    _openapi_field_ae =
        _decode(Float64, _required(_openapi_object, "Ae", "AVRTypeI"), false)
    _openapi_field_be =
        _decode(Float64, _required(_openapi_object, "Be", "AVRTypeI"), false)
...
function _encode_unvalidated(_openapi_value::AVRTypeI)
...
_encode(_openapi_value::AVRTypeI) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-892d13ecd9962e90fbb4.json",
        pointer="",
