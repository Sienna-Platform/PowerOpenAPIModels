...
_decode(::Type{SauerPaiMachine}, value) = _decode(SauerPaiMachine, value, true)
function _decode(::Type{SauerPaiMachine}, _openapi_raw, _openapi_validate::Bool)
