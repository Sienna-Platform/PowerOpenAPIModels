...
function _encode_unvalidated(_openapi_value::PriorityOutputCurrentLimiter)
    ...
    _openapi_value.phi_i isa Absent ||
        (_openapi_output["phi_I"] = _encode_unvalidated(_openapi_value.phi_i))
...
_encode(_openapi_value::PriorityOutputCurrentLimiter) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-314f76dd32be8f535561.json",
        pointer="",
