...
function _encode_unvalidated(_openapi_value::SaturationOutputCurrentLimiter)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.i_max isa Absent ||
        (_openapi_output["I_max"] = _encode_unvalidated(_openapi_value.i_max))
    _openapi_value.kw isa Absent ||
        (_openapi_output["kw"] = _encode_unvalidated(_openapi_value.kw))
...
_encode(_openapi_value::SaturationOutputCurrentLimiter) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-d4b4b7eb77a3720153e8.json",
        pointer="",
