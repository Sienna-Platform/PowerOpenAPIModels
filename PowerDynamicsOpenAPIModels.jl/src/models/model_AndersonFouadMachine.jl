...
_decode(::Type{AndersonFouadMachine}, value) = _decode(AndersonFouadMachine, value, true)
function _decode(::Type{AndersonFouadMachine}, _openapi_raw, _openapi_validate::Bool)
