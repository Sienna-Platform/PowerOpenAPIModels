...
function _decode(::Type{ReactivePowerPI}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_kp_q =
        _decode(Float64, _required(_openapi_object, "Kp_q", "ReactivePowerPI"), false)
    _openapi_field_ki_q =
        _decode(Float64, _required(_openapi_object, "Ki_q", "ReactivePowerPI"), false)
    _openapi_field_omegaf =
        _decode(Float64, _required(_openapi_object, "omegaf", "ReactivePowerPI"), false)
...
function _encode_unvalidated(_openapi_value::ReactivePowerPI)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.kp_q isa Absent ||
        (_openapi_output["Kp_q"] = _encode_unvalidated(_openapi_value.kp_q))
    _openapi_value.ki_q isa Absent ||
        (_openapi_output["Ki_q"] = _encode_unvalidated(_openapi_value.ki_q))
    _openapi_value.omegaf isa Absent ||
        (_openapi_output["omegaf"] = _encode_unvalidated(_openapi_value.omegaf))
...
_encode(_openapi_value::ReactivePowerPI) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-a1ec0a2b1cc7f385d635.json",
        pointer="",
