...
function _decode(::Type{LCLFilter}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_lf =
        _decode(Float64, _required(_openapi_object, "lf", "LCLFilter"), false)
    _openapi_field_rf =
        _decode(Float64, _required(_openapi_object, "rf", "LCLFilter"), false)
    _openapi_field_cf =
        _decode(Float64, _required(_openapi_object, "cf", "LCLFilter"), false)
    _openapi_field_lg =
        _decode(Float64, _required(_openapi_object, "lg", "LCLFilter"), false)
    _openapi_field_rg =
        _decode(Float64, _required(_openapi_object, "rg", "LCLFilter"), false)
...
function _encode_unvalidated(_openapi_value::LCLFilter)
    ...
    _openapi_value.lg isa Absent ||
        (_openapi_output["lg"] = _encode_unvalidated(_openapi_value.lg))
    _openapi_value.rg isa Absent ||
        (_openapi_output["rg"] = _encode_unvalidated(_openapi_value.rg))
...
_encode(_openapi_value::LCLFilter) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-6db50b57961cd5255ee1.json",
        pointer="",
