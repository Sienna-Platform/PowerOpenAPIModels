...
function _decode(::Type{ReducedOrderPLL}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_omega_lp = _decode(
        Float64,
        _required(_openapi_object, "omega_lp", "ReducedOrderPLL"),
        _openapi_validate,
    )
    _openapi_field_kp_pll = _decode(
        Float64,
        _required(_openapi_object, "kp_pll", "ReducedOrderPLL"),
        _openapi_validate,
    )
    _openapi_field_ki_pll = _decode(
        Float64,
        _required(_openapi_object, "ki_pll", "ReducedOrderPLL"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::ReducedOrderPLL)
