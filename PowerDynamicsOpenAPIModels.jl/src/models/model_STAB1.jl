...
function _decode(::Type{STAB1}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(Int64, _required(_openapi_object, "id", "STAB1"), false)
    _openapi_field_kt = _decode(Float64, _required(_openapi_object, "KT", "STAB1"), false)
    _openapi_field_t = _decode(Float64, _required(_openapi_object, "T", "STAB1"), false)
    _openapi_field_t1t3 =
        _decode(Float64, _required(_openapi_object, "T1T3", "STAB1"), false)
    _openapi_field_t3 = _decode(Float64, _required(_openapi_object, "T3", "STAB1"), false)
    _openapi_field_t2t4 =
        _decode(Float64, _required(_openapi_object, "T2T4", "STAB1"), false)
    _openapi_field_t4 = _decode(Float64, _required(_openapi_object, "T4", "STAB1"), false)
    _openapi_field_h_lim =
        _decode(Float64, _required(_openapi_object, "H_lim", "STAB1"), false)
...
function _encode_unvalidated(_openapi_value::STAB1)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.id isa Absent ||
        (_openapi_output["id"] = _encode_unvalidated(_openapi_value.id))
    _openapi_value.kt isa Absent ||
        (_openapi_output["KT"] = _encode_unvalidated(_openapi_value.kt))
    _openapi_value.t isa Absent ||
        (_openapi_output["T"] = _encode_unvalidated(_openapi_value.t))
    _openapi_value.t1t3 isa Absent ||
        (_openapi_output["T1T3"] = _encode_unvalidated(_openapi_value.t1t3))
    _openapi_value.t3 isa Absent ||
        (_openapi_output["T3"] = _encode_unvalidated(_openapi_value.t3))
    _openapi_value.t2t4 isa Absent ||
        (_openapi_output["T2T4"] = _encode_unvalidated(_openapi_value.t2t4))
    _openapi_value.t4 isa Absent ||
        (_openapi_output["T4"] = _encode_unvalidated(_openapi_value.t4))
    _openapi_value.h_lim isa Absent ||
        (_openapi_output["H_lim"] = _encode_unvalidated(_openapi_value.h_lim))
...
_encode(_openapi_value::STAB1) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-6242798e0b7a8f19429d.json",
        pointer="",
