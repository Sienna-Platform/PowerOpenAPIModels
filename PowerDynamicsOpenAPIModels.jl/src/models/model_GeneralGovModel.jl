...
function _decode(::Type{GeneralGovModel}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id =
        _decode(Int64, _required(_openapi_object, "id", "GeneralGovModel"), false)
    _openapi_field_r_select =
        haskey(_openapi_object, "R_select") ?
        _decode(Union{Absent, Int64, Nothing}, _openapi_object["R_select"], false) : ABSENT
    _openapi_field_fuel_flag =
        _decode(Int64, _required(_openapi_object, "fuel_flag", "GeneralGovModel"), false)
    _openapi_field_r =
        haskey(_openapi_object, "R") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["R"], false) : ABSENT
    _openapi_field_tpelec =
        _decode(Float64, _required(_openapi_object, "Tpelec", "GeneralGovModel"), false)
    _openapi_field_speed_error_signal = _decode(
        MinMax,
        _required(_openapi_object, "speed_error_signal", "GeneralGovModel"),
        false,
    )
    _openapi_field_kp_gov =
        _decode(Float64, _required(_openapi_object, "Kp_gov", "GeneralGovModel"), false)
    _openapi_field_ki_gov =
        _decode(Float64, _required(_openapi_object, "Ki_gov", "GeneralGovModel"), false)
    _openapi_field_kd_gov =
        _decode(Float64, _required(_openapi_object, "Kd_gov", "GeneralGovModel"), false)
    _openapi_field_td_gov =
        _decode(Float64, _required(_openapi_object, "Td_gov", "GeneralGovModel"), false)
    _openapi_field_valve_position_limits = _decode(
        MinMax,
        _required(_openapi_object, "valve_position_limits", "GeneralGovModel"),
        false,
    )
    _openapi_field_t_act =
        _decode(Float64, _required(_openapi_object, "T_act", "GeneralGovModel"), false)
    _openapi_field_k_turb =
        _decode(Float64, _required(_openapi_object, "K_turb", "GeneralGovModel"), false)
    _openapi_field_wf_nl =
        _decode(Float64, _required(_openapi_object, "Wf_nl", "GeneralGovModel"), false)
    _openapi_field_tb =
        _decode(Float64, _required(_openapi_object, "Tb", "GeneralGovModel"), false)
    _openapi_field_tc =
        _decode(Float64, _required(_openapi_object, "Tc", "GeneralGovModel"), false)
    _openapi_field_t_eng =
        _decode(Float64, _required(_openapi_object, "T_eng", "GeneralGovModel"), false)
    _openapi_field_tf_load =
        _decode(Float64, _required(_openapi_object, "Tf_load", "GeneralGovModel"), false)
    _openapi_field_kp_load =
        _decode(Float64, _required(_openapi_object, "Kp_load", "GeneralGovModel"), false)
    _openapi_field_ki_load =
        _decode(Float64, _required(_openapi_object, "Ki_load", "GeneralGovModel"), false)
    _openapi_field_ld_ref =
        _decode(Float64, _required(_openapi_object, "Ld_ref", "GeneralGovModel"), false)
    _openapi_field_dm =
        _decode(Float64, _required(_openapi_object, "Dm", "GeneralGovModel"), false)
    _openapi_field_r_open =
        _decode(Float64, _required(_openapi_object, "R_open", "GeneralGovModel"), false)
    _openapi_field_r_close =
        _decode(Float64, _required(_openapi_object, "R_close", "GeneralGovModel"), false)
    _openapi_field_ki_mw =
        _decode(Float64, _required(_openapi_object, "Ki_mw", "GeneralGovModel"), false)
    _openapi_field_a_set =
        _decode(Float64, _required(_openapi_object, "A_set", "GeneralGovModel"), false)
    _openapi_field_ka =
        _decode(Float64, _required(_openapi_object, "Ka", "GeneralGovModel"), false)
    _openapi_field_ta =
        _decode(Float64, _required(_openapi_object, "Ta", "GeneralGovModel"), false)
    _openapi_field_t_rate =
        _decode(Float64, _required(_openapi_object, "T_rate", "GeneralGovModel"), false)
    _openapi_field_db =
        _decode(Float64, _required(_openapi_object, "db", "GeneralGovModel"), false)
    _openapi_field_tsa =
        _decode(Float64, _required(_openapi_object, "Tsa", "GeneralGovModel"), false)
    _openapi_field_tsb =
        _decode(Float64, _required(_openapi_object, "Tsb", "GeneralGovModel"), false)
    _openapi_field_r_lim =
        _decode(UpDown, _required(_openapi_object, "R_lim", "GeneralGovModel"), false)
...
function _encode_unvalidated(_openapi_value::GeneralGovModel)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.id isa Absent ||
        (_openapi_output["id"] = _encode_unvalidated(_openapi_value.id))
    _openapi_value.r_select isa Absent ||
        (_openapi_output["R_select"] = _encode_unvalidated(_openapi_value.r_select))
    _openapi_value.fuel_flag isa Absent ||
        (_openapi_output["fuel_flag"] = _encode_unvalidated(_openapi_value.fuel_flag))
    _openapi_value.r isa Absent ||
        (_openapi_output["R"] = _encode_unvalidated(_openapi_value.r))
    _openapi_value.tpelec isa Absent ||
        (_openapi_output["Tpelec"] = _encode_unvalidated(_openapi_value.tpelec))
    _openapi_value.speed_error_signal isa Absent || (
        _openapi_output["speed_error_signal"] =
            _encode_unvalidated(_openapi_value.speed_error_signal)
    )
    _openapi_value.kp_gov isa Absent ||
        (_openapi_output["Kp_gov"] = _encode_unvalidated(_openapi_value.kp_gov))
    _openapi_value.ki_gov isa Absent ||
        (_openapi_output["Ki_gov"] = _encode_unvalidated(_openapi_value.ki_gov))
    _openapi_value.kd_gov isa Absent ||
        (_openapi_output["Kd_gov"] = _encode_unvalidated(_openapi_value.kd_gov))
    _openapi_value.td_gov isa Absent ||
        (_openapi_output["Td_gov"] = _encode_unvalidated(_openapi_value.td_gov))
    ...
    _openapi_value.t_act isa Absent ||
        (_openapi_output["T_act"] = _encode_unvalidated(_openapi_value.t_act))
    _openapi_value.k_turb isa Absent ||
        (_openapi_output["K_turb"] = _encode_unvalidated(_openapi_value.k_turb))
    _openapi_value.wf_nl isa Absent ||
        (_openapi_output["Wf_nl"] = _encode_unvalidated(_openapi_value.wf_nl))
    ...
    _openapi_value.t_eng isa Absent ||
        (_openapi_output["T_eng"] = _encode_unvalidated(_openapi_value.t_eng))
    _openapi_value.tf_load isa Absent ||
        (_openapi_output["Tf_load"] = _encode_unvalidated(_openapi_value.tf_load))
    _openapi_value.kp_load isa Absent ||
        (_openapi_output["Kp_load"] = _encode_unvalidated(_openapi_value.kp_load))
    _openapi_value.ki_load isa Absent ||
        (_openapi_output["Ki_load"] = _encode_unvalidated(_openapi_value.ki_load))
    _openapi_value.ld_ref isa Absent ||
        (_openapi_output["Ld_ref"] = _encode_unvalidated(_openapi_value.ld_ref))
    _openapi_value.dm isa Absent ||
        (_openapi_output["Dm"] = _encode_unvalidated(_openapi_value.dm))
    _openapi_value.r_open isa Absent ||
        (_openapi_output["R_open"] = _encode_unvalidated(_openapi_value.r_open))
    _openapi_value.r_close isa Absent ||
        (_openapi_output["R_close"] = _encode_unvalidated(_openapi_value.r_close))
    _openapi_value.ki_mw isa Absent ||
        (_openapi_output["Ki_mw"] = _encode_unvalidated(_openapi_value.ki_mw))
    _openapi_value.a_set isa Absent ||
        (_openapi_output["A_set"] = _encode_unvalidated(_openapi_value.a_set))
    ...
    _openapi_value.db isa Absent ||
        (_openapi_output["db"] = _encode_unvalidated(_openapi_value.db))
    _openapi_value.tsa isa Absent ||
        (_openapi_output["Tsa"] = _encode_unvalidated(_openapi_value.tsa))
    _openapi_value.tsb isa Absent ||
        (_openapi_output["Tsb"] = _encode_unvalidated(_openapi_value.tsb))
    _openapi_value.r_lim isa Absent ||
        (_openapi_output["R_lim"] = _encode_unvalidated(_openapi_value.r_lim))
...
_encode(_openapi_value::GeneralGovModel) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-a34a39bdd6a0f2f0922f.json",
        pointer="",
