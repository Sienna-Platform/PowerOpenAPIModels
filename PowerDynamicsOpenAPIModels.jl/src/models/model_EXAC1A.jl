...
function _decode(::Type{EXAC1A}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(Int64, _required(_openapi_object, "id", "EXAC1A"), false)
    _openapi_field_tr = _decode(Float64, _required(_openapi_object, "Tr", "EXAC1A"), false)
    _openapi_field_tb = _decode(Float64, _required(_openapi_object, "Tb", "EXAC1A"), false)
    _openapi_field_tc = _decode(Float64, _required(_openapi_object, "Tc", "EXAC1A"), false)
    _openapi_field_ka = _decode(Float64, _required(_openapi_object, "Ka", "EXAC1A"), false)
    _openapi_field_ta = _decode(Float64, _required(_openapi_object, "Ta", "EXAC1A"), false)
    _openapi_field_va_lim =
        _decode(MinMax, _required(_openapi_object, "Va_lim", "EXAC1A"), false)
    _openapi_field_te = _decode(Float64, _required(_openapi_object, "Te", "EXAC1A"), false)
    _openapi_field_kf = _decode(Float64, _required(_openapi_object, "Kf", "EXAC1A"), false)
    _openapi_field_tf = _decode(Float64, _required(_openapi_object, "Tf", "EXAC1A"), false)
    _openapi_field_kc = _decode(Float64, _required(_openapi_object, "Kc", "EXAC1A"), false)
    _openapi_field_kd = _decode(Float64, _required(_openapi_object, "Kd", "EXAC1A"), false)
    _openapi_field_ke = _decode(Float64, _required(_openapi_object, "Ke", "EXAC1A"), false)
    _openapi_field_e_sat =
        _decode(Vector{Float64}, _required(_openapi_object, "E_sat", "EXAC1A"), false)
    _openapi_field_se =
        _decode(Vector{Float64}, _required(_openapi_object, "Se", "EXAC1A"), false)
    _openapi_field_vr_lim =
        _decode(MinMax, _required(_openapi_object, "Vr_lim", "EXAC1A"), false)
...
function _encode_unvalidated(_openapi_value::EXAC1A)
...
_encode(_openapi_value::EXAC1A) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-73fd9a5f2963d61da2b7.json",
        pointer="",
