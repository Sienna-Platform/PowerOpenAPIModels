...
function _decode(::Type{ZeroOrderBESS}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_fs =
        _decode(Float64, _required(_openapi_object, "fs", "ZeroOrderBESS"), false)
    _openapi_field_kpv =
        _decode(Float64, _required(_openapi_object, "kpv", "ZeroOrderBESS"), false)
    _openapi_field_kiv =
        _decode(Float64, _required(_openapi_object, "kiv", "ZeroOrderBESS"), false)
    _openapi_field_kpi =
        _decode(Float64, _required(_openapi_object, "kpi", "ZeroOrderBESS"), false)
    _openapi_field_kii =
        _decode(Float64, _required(_openapi_object, "kii", "ZeroOrderBESS"), false)
    _openapi_field_vdc_ref =
        haskey(_openapi_object, "Vdc_ref") ?
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["Vdc_ref"], false) : ABSENT
...
function _encode_unvalidated(_openapi_value::ZeroOrderBESS)
    ...
    _openapi_value.battery_voltage isa Absent || (
        _openapi_output["battery_voltage"] =
            _encode_unvalidated(_openapi_value.battery_voltage)
    )
    _openapi_value.battery_resistance isa Absent || (
        _openapi_output["battery_resistance"] =
            _encode_unvalidated(_openapi_value.battery_resistance)
    )
    _openapi_value.dc_dc_inductor isa Absent || (
        _openapi_output["dc_dc_inductor"] =
            _encode_unvalidated(_openapi_value.dc_dc_inductor)
    )
    _openapi_value.dc_link_capacitance isa Absent || (
        _openapi_output["dc_link_capacitance"] =
            _encode_unvalidated(_openapi_value.dc_link_capacitance)
    )
    _openapi_value.fs isa Absent ||
        (_openapi_output["fs"] = _encode_unvalidated(_openapi_value.fs))
    ...
    _openapi_value.kpi isa Absent ||
        (_openapi_output["kpi"] = _encode_unvalidated(_openapi_value.kpi))
    _openapi_value.kii isa Absent ||
        (_openapi_output["kii"] = _encode_unvalidated(_openapi_value.kii))
    _openapi_value.vdc_ref isa Absent ||
        (_openapi_output["Vdc_ref"] = _encode_unvalidated(_openapi_value.vdc_ref))
...
_encode(_openapi_value::ZeroOrderBESS) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-3a21f48d52b927180f79.json",
        pointer="",
