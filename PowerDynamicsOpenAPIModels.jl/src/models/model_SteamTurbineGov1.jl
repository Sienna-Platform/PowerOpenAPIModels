...
function _decode(::Type{SteamTurbineGov1}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_r = _decode(
        Float64,
        _required(_openapi_object, "R", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_t1 = _decode(
        Float64,
        _required(_openapi_object, "T1", "SteamTurbineGov1"),
        _openapi_validate,
    )
    ...
    _openapi_field_t2 = _decode(
        Float64,
        _required(_openapi_object, "T2", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_t3 = _decode(
        Float64,
        _required(_openapi_object, "T3", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_d_t = _decode(
        Float64,
        _required(_openapi_object, "D_T", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_db_h = _decode(
        Float64,
        _required(_openapi_object, "DB_h", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_db_l = _decode(
        Float64,
        _required(_openapi_object, "DB_l", "SteamTurbineGov1"),
        _openapi_validate,
    )
    _openapi_field_t_rate = _decode(
        Float64,
        _required(_openapi_object, "T_rate", "SteamTurbineGov1"),
        _openapi_validate,
    )
...
function _encode(_openapi_value::SteamTurbineGov1)
    ...
    _openapi_value.db_h isa Absent ||
        (_openapi_output["DB_h"] = _encode(_openapi_value.db_h))
    _openapi_value.db_l isa Absent ||
        (_openapi_output["DB_l"] = _encode(_openapi_value.db_l))
