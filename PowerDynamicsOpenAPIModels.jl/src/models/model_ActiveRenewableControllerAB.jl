...
function _decode(::Type{ActiveRenewableControllerAB}, _openapi_raw, _openapi_validate::Bool)
    _openapi_validate && _validate_schema(
        _SPEC,
        (
            resource="https://openapi.invalid/schema/external-6042dffc10c3f7c3e56f.json",
            pointer="",
        ),
        _openapi_raw,
...
function _encode(_openapi_value::ActiveRenewableControllerAB)
    ...
    _openapi_value.freq_flag isa Absent ||
        (_openapi_output["Freq_Flag"] = _encode(_openapi_value.freq_flag))
    _openapi_value.k_pg isa Absent ||
        (_openapi_output["K_pg"] = _encode(_openapi_value.k_pg))
    _openapi_value.k_ig isa Absent ||
        (_openapi_output["K_ig"] = _encode(_openapi_value.k_ig))
    _openapi_value.t_p isa Absent || (_openapi_output["T_p"] = _encode(_openapi_value.t_p))
    _openapi_value.fdbd_pnts isa Absent ||
        (_openapi_output["fdbd_pnts"] = _encode(_openapi_value.fdbd_pnts))
    _openapi_value.fe_lim isa Absent ||
        (_openapi_output["fe_lim"] = _encode(_openapi_value.fe_lim))
    ...
    _openapi_value.d_dn isa Absent ||
        (_openapi_output["D_dn"] = _encode(_openapi_value.d_dn))
    _openapi_value.d_up isa Absent ||
        (_openapi_output["D_up"] = _encode(_openapi_value.d_up))
    _openapi_value.dp_lim isa Absent ||
        (_openapi_output["dP_lim"] = _encode(_openapi_value.dp_lim))
    _openapi_value.p_lim_inner isa Absent ||
        (_openapi_output["P_lim_inner"] = _encode(_openapi_value.p_lim_inner))
    _openapi_value.t_pord isa Absent ||
        (_openapi_output["T_pord"] = _encode(_openapi_value.t_pord))
