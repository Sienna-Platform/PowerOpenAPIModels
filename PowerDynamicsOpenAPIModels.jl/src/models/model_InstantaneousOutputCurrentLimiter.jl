...
function _encode_unvalidated(_openapi_value::InstantaneousOutputCurrentLimiter)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.id_max isa Absent ||
        (_openapi_output["Id_max"] = _encode_unvalidated(_openapi_value.id_max))
    _openapi_value.iq_max isa Absent ||
        (_openapi_output["Iq_max"] = _encode_unvalidated(_openapi_value.iq_max))
...
_encode(_openapi_value::InstantaneousOutputCurrentLimiter) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-83719096b02c875b91f1.json",
        pointer="",
