...
function _decode(::Type{LCFilter}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_lf =
        _decode(Float64, _required(_openapi_object, "lf", "LCFilter"), _openapi_validate)
    _openapi_field_rf =
        _decode(Float64, _required(_openapi_object, "rf", "LCFilter"), _openapi_validate)
    _openapi_field_cf =
        _decode(Float64, _required(_openapi_object, "cf", "LCFilter"), _openapi_validate)
...
function _encode(_openapi_value::LCFilter)
