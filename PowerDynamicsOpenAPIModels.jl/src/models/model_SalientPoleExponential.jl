...
function _decode(::Type{SalientPoleExponential}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_id = _decode(
        Int64,
        _required(_openapi_object, "id", "SalientPoleExponential"),
        _openapi_validate,
    )
    ...
    for (_openapi_key, _openapi_item) in _openapi_object
        String(_openapi_key) in ("base_machine", "id", "saturation_coeffs") && continue
...
function _encode(_openapi_value::SalientPoleExponential)
