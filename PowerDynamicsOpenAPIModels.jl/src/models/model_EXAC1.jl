...
"""
Base.@kwdef struct EXAC1 <: APIModel
    id::Int64
    tr::Float64
    tb::Float64
    tc::Float64
...
_decode(::Type{EXAC1}, value) = _decode(EXAC1, value, true)
function _decode(::Type{EXAC1}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_object = _object(_openapi_raw, "EXAC1")
    _openapi_field_id = _decode(Int64, _required(_openapi_object, "id", "EXAC1"), false)
    _openapi_field_tr = _decode(Float64, _required(_openapi_object, "Tr", "EXAC1"), false)
    _openapi_field_tb = _decode(Float64, _required(_openapi_object, "Tb", "EXAC1"), false)
    _openapi_field_tc = _decode(Float64, _required(_openapi_object, "Tc", "EXAC1"), false)
    _openapi_field_ka = _decode(Float64, _required(_openapi_object, "Ka", "EXAC1"), false)
    _openapi_field_ta = _decode(Float64, _required(_openapi_object, "Ta", "EXAC1"), false)
    _openapi_field_vr_lim =
        _decode(MinMax, _required(_openapi_object, "Vr_lim", "EXAC1"), false)
    _openapi_field_te = _decode(Float64, _required(_openapi_object, "Te", "EXAC1"), false)
    _openapi_field_kf = _decode(Float64, _required(_openapi_object, "Kf", "EXAC1"), false)
    _openapi_field_tf = _decode(Float64, _required(_openapi_object, "Tf", "EXAC1"), false)
    _openapi_field_kc = _decode(Float64, _required(_openapi_object, "Kc", "EXAC1"), false)
    _openapi_field_kd = _decode(Float64, _required(_openapi_object, "Kd", "EXAC1"), false)
    _openapi_field_ke = _decode(Float64, _required(_openapi_object, "Ke", "EXAC1"), false)
    _openapi_field_e_sat =
        _decode(Vector{Float64}, _required(_openapi_object, "E_sat", "EXAC1"), false)
    _openapi_field_se =
        _decode(Vector{Float64}, _required(_openapi_object, "Se", "EXAC1"), false)
...
function _encode_unvalidated(_openapi_value::EXAC1)
...
_encode(_openapi_value::EXAC1) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-06319b21427388d224a2.json",
        pointer="",
...
function _form_fields(_openapi_value::EXAC1)
