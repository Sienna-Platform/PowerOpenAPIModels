...
function _decode(::Type{RLFilter}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_rf =
        _decode(Float64, _required(_openapi_object, "rf", "RLFilter"), false)
    _openapi_field_lf =
        _decode(Float64, _required(_openapi_object, "lf", "RLFilter"), false)
...
function _encode_unvalidated(_openapi_value::RLFilter)
...
_encode(_openapi_value::RLFilter) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-bb23878097772a3fcbf8.json",
        pointer="",
