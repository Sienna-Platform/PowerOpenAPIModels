...
function _decode(::Type{FixedFrequency}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_frequency =
        ...
        _decode(Union{Absent, Float64, Nothing}, _openapi_object["frequency"], false) :
        ABSENT
...
function _encode_unvalidated(_openapi_value::FixedFrequency)
    _openapi_output = JSON.Object{String, Any}()
    _openapi_value.frequency isa Absent ||
        (_openapi_output["frequency"] = _encode_unvalidated(_openapi_value.frequency))
...
_encode(_openapi_value::FixedFrequency) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-6f9b5c0d55fa44829a42.json",
        pointer="",
