...
function _decode(::Type{VirtualInertia}, _openapi_raw, _openapi_validate::Bool)
    ...
    _openapi_field_ta =
        _decode(Float64, _required(_openapi_object, "Ta", "VirtualInertia"), false)
    _openapi_field_kd =
        _decode(Float64, _required(_openapi_object, "kd", "VirtualInertia"), false)
    _openapi_field_komega =
        _decode(Float64, _required(_openapi_object, "komega", "VirtualInertia"), false)
...
function _encode_unvalidated(_openapi_value::VirtualInertia)
    ...
    _openapi_value.komega isa Absent ||
        (_openapi_output["komega"] = _encode_unvalidated(_openapi_value.komega))
...
_encode(_openapi_value::VirtualInertia) = _validate_schema(
    _SPEC,
    (
        resource="https://openapi.invalid/schema/external-1c07cc56c57f877e86fc.json",
        pointer="",
