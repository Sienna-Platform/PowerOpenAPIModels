...
**`Tk`** | **`Float64`** | Voltage regulator lead time constant | [default to nothing]
...
**`VFE_lim`** | **`Float64`** | Exciter field current limiter reference | [default to nothing]
**`Kh`** | **`Float64`** | Exciter field current regulator feedback gain | [default to nothing]
**`VH_max`** | **`Float64`** | Exciter field current limiter maximum output | [default to nothing]
**`Th`** | **`Float64`** | Exciter field current limiter denominator (lag) time constant | [default to nothing]
**`Tj`** | **`Float64`** | Exciter field current limiter (lead) time constant | [default to nothing]
