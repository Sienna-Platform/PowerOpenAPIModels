...
**`Kb`** | **`Float64`** | Second stage regulator gain | [default to nothing]
**`Vr_lim`** | [**`*MinMax`**](MinMax.md) |  | [default to nothing]
**`Te`** | **`Float64`** | Exciter field time constant | [default to nothing]
**`Kl`** | **`Float64`** | Exciter field current limiter gain | [default to nothing]
...
**`V_lr`** | **`Float64`** | Maximum exciter field current | [default to nothing]
